...
import { localizedSurfaceEntry } from "../../../core/frontend/spa/src/build/surface-locales";
import { createImportMap } from "../../../core/frontend/spa/src/import-map";
...
async function writeServiceEntry(
	...
	const source = `// Generated by tools/registry/src/build.ts — do not edit.
...
async function buildObjectIndex(
	...
	const { collectObjectIndex } = await import(
		"../../../core/frontend/spa/src/build/object-index"
	);
...
/**
 * The mapping again, this time as Helm values for `tools/install/chart`.
 *
