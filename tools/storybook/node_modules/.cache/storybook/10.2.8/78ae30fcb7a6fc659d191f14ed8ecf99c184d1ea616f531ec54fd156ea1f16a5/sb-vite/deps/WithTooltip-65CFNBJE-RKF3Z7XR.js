...
// ../../node_modules/.bun/storybook@10.2.8+57c300bd6617d60e/node_modules/storybook/dist/_browser-chunks/WithTooltip-65CFNBJE.js
init_compat_module();
init_compat_module();
...
var ManagerReferenceNodeContext = Q();
var ManagerReferenceNodeSetterContext = Q();
...
var useIsomorphicLayoutEffect = typeof window < "u" && window.document && window.document.createElement ? _ : y;
var top = "top";
var bottom = "bottom";
var right = "right";
var left = "left";
...
function getBoundingClientRect(element, includeScale, isFixedStrategy) {
  ...
  var _ref = isElement(element) ? getWindow(element) : window, visualViewport = _ref.visualViewport, addVisualOffsets = !isLayoutViewport() && isFixedStrategy, x = (clientRect.left + (addVisualOffsets && visualViewport ? visualViewport.offsetLeft : 0)) / scaleX, y2 = (clientRect.top + (addVisualOffsets && visualViewport ? visualViewport.offsetTop : 0)) / scaleY, width = clientRect.width / scaleX, height = clientRect.height / scaleY;
  return {
    width,
    height,
    top: y2,
...
function roundOffsetsByDPR(_ref, win) {
  var x = _ref.x, y2 = _ref.y, dpr = win.devicePixelRatio || 1;
  return {
    x: round(x * dpr) / dpr || 0,
...
function mapToStyles(_ref2) {
  var _Object$assign2, popper2 = _ref2.popper, popperRect = _ref2.popperRect, placement = _ref2.placement, variation = _ref2.variation, offsets = _ref2.offsets, position = _ref2.position, gpuAcceleration = _ref2.gpuAcceleration, adaptive = _ref2.adaptive, roundOffsets = _ref2.roundOffsets, isFixed = _ref2.isFixed, _offsets$x = offsets.x, x = _offsets$x === void 0 ? 0 : _offsets$x, _offsets$y = offsets.y, y2 = _offsets$y === void 0 ? 0 : _offsets$y, _ref3 = typeof roundOffsets == "function" ? roundOffsets({
    x,
    y: y2
  }) : {
    x,
  ...
  if (x = _ref4.x, y2 = _ref4.y, gpuAcceleration) {
    var _Object$assign;
...
function getViewportRect(element, strategy) {
  var win = getWindow(element), html = getDocumentElement(element), visualViewport = win.visualViewport, width = html.clientWidth, height = html.clientHeight, x = 0, y2 = 0;
  if (visualViewport) {
    width = visualViewport.width, height = visualViewport.height;
    var layoutViewport = isLayoutViewport();
    (layoutViewport || !layoutViewport && strategy === "fixed") && (x = visualViewport.offsetLeft, y2 = visualViewport.offsetTop);
  }
  return {
    width,
    height,
...
function offset(_ref2) {
  ...
  }, {}), _data$state$placement = data[state.placement], x = _data$state$placement.x, y2 = _data$state$placement.y;
  state.modifiersData.popperOffsets != null && (state.modifiersData.popperOffsets.x += x, state.modifiersData.popperOffsets.y += y2), state.modifiersData[name] = data;
}
var offset_default = {
  name: "offset",
  enabled: true,
...
var usePopper = function(referenceElement, popperElement, options) {
  options === void 0 && (options = {});
  var prevOptions = A(null), optionsWithDefaults = {
    ...
    attributes: {}
  }), state = _React$useState[0], setState = _React$useState[1], updateStateModifier = T(function() {
    return {
      name: "updateState",
      enabled: true,
      phase: "write",
  ...
  }, [optionsWithDefaults.onFirstUpdate, optionsWithDefaults.placement, optionsWithDefaults.strategy, optionsWithDefaults.modifiers, updateStateModifier]), popperInstanceRef = A();
...
function useGetLatest(val) {
  var ref = A(val);
  return ref.current = val, q(function() {
    return ref.current;
  }, []);
}
var noop = function() {
...
function useControlledState(_ref) {
  ...
  var _React$useState = d(initial), state = _React$useState[0], setState = _React$useState[1], getLatest = useGetLatest(state), set = q(function(updater) {
...
function generateBoundingClientRect(x, y2) {
  return x === void 0 && (x = 0), y2 === void 0 && (y2 = 0), function() {
    return {
      width: 0,
      height: 0,
      top: y2,
...
function usePopperTooltip(config, popperOptions) {
  ...
  }), _React$useState = d(null), triggerRef = _React$useState[0], setTriggerRef = _React$useState[1], _React$useState2 = d(null), tooltipRef = _React$useState2[0], setTooltipRef = _React$useState2[1], _useControlledState = useControlledState({
    initial: finalConfig.defaultVisible,
    value: finalConfig.visible,
    onChange: finalConfig.onVisibleChange
  }), visible = _useControlledState[0], setVisible = _useControlledState[1], timer = A();
  y(function() {
    return function() {
  ...
  ), hideTooltip = q(function() {
    clearTimeout(timer.current), timer.current = window.setTimeout(function() {
      return setVisible(false);
    }, finalConfig.delayHide);
  }, [finalConfig.delayHide, setVisible]), showTooltip = q(function() {
    clearTimeout(timer.current), timer.current = window.setTimeout(function() {
      return setVisible(true);
    }, finalConfig.delayShow);
  }, [finalConfig.delayShow, setVisible]), toggleTooltip = q(function() {
  ...
  }, [getLatest, hideTooltip]), y(function() {
  ...
  }, [triggerRef, isTriggeredBy, toggleTooltip]), y(function() {
  ...
  }, [triggerRef, isTriggeredBy, showTooltip, hideTooltip]), y(function() {
  ...
  }, [finalConfig.closeOnTriggerHidden, hideTooltip, isReferenceHidden]), y(function() {
  ...
  }, [finalConfig.followCursor, triggerRef, update]), y(function() {
...
var Arrow = styled.div(
  ...
  ({ placement }) => {
    ...
    return { transform: `translate3d(${x}px, ${y2}px, 0px)` };
  },
...
var Tooltip = xn.forwardRef(
  ({
    ...
    withArrows,
    ...props
  }, ref) => xn.createElement(Wrapper, { "data-testid": "tooltip", hasChrome, ref, ...props, color }, hasChrome && withArrows && xn.createElement(Arrow, { placement, ...arrowProps, color }), children)
);
...
var WithTooltipPure = ({
  ...
  ), portalTarget = (typeof portalContainer == "string" ? document2.querySelector(portalContainer) : portalContainer) || document2.body, tooltipComponent = isVisible ? xn.createElement(
    Tooltip,
    {
  ...
  return xn.createElement(xn.Fragment, null, xn.createElement(Container, { trigger, ref: setTriggerRef, ...props }, children), isVisible && xn.createPortal(tooltipComponent, portalTarget));
};
var WithToolTipState = ({
  ...
  let [tooltipShown, setTooltipShown] = d(startOpen), onVisibilityChange = q(
    (visibility) => {
  ...
  }), xn.createElement(WithTooltipPure, { ...rest, visible: tooltipShown, onVisibleChange: onVisibilityChange });
};
...
), xn.createElement(WithTooltipPure, { "data-deprecated": "WithTooltipPure", ...props }));
...
), xn.createElement(WithToolTipState, { "data-deprecated": "WithToolTipState", ...props }));
export {
  Tooltip,
...
//# sourceMappingURL=WithTooltip-65CFNBJE-RKF3Z7XR.js.map
