...
import {
  ...
  nameSpaceClassNames,
  withReset
} from "./chunk-LHDHVMSF.js";
import {
  ActionBar
} from "./chunk-EXCIRHG2.js";
import {
  ThemeProvider,
  convert,
  ensure,
  ...
  themes,
  useTheme
} from "./chunk-SQMEYDUR.js";
import {
  require_channels
} from "./chunk-BQ3GRZSB.js";
import {
  require_client_logger
} from "./chunk-DDS7QGHY.js";
import {
  require_core_events
} from "./chunk-NWASSBAF.js";
import {
  O,
  P,
  _n,
...
// ../../node_modules/.bun/@storybook+addon-docs@10.2.8+29ab0d4c53492907/node_modules/@storybook/addon-docs/dist/_browser-chunks/chunk-AAVP3AE4.js
init_compat_module();
init_compat_module();
function _extends() {
...
function mix(weight, color, otherColor) {
  ...
  }), alphaDelta = color1.alpha - color2.alpha, x4 = parseFloat(weight) * 2 - 1, y3 = x4 * alphaDelta === -1 ? x4 : x4 + alphaDelta, z3 = 1 + x4 * alphaDelta, weight1 = (y3 / z3 + 1) / 2, weight2 = 1 - weight1, mixedColor = {
...
var EmptyBlock = (props) => xn.createElement(Wrapper, { ...props, className: "docblock-emptyblock sb-unstyled" });
...
var SourceSkeleton = () => xn.createElement(SourceSkeletonWrapper, null, xn.createElement(SourceSkeletonPlaceholder, null), xn.createElement(SourceSkeletonPlaceholder, { style: { width: "80%" } }), xn.createElement(SourceSkeletonPlaceholder, { style: { width: "30%" } }), xn.createElement(SourceSkeletonPlaceholder, { style: { width: "80%" } }));
var Source = ({
  isLoading,
  error,
  language,
  ...
  if (isLoading)
    return xn.createElement(SourceSkeleton, null);
  if (error)
    return xn.createElement(EmptyBlock, null, error);
  let syntaxHighlighter = xn.createElement(
...
// ../../node_modules/.bun/@storybook+addon-docs@10.2.8+29ab0d4c53492907/node_modules/@storybook/addon-docs/dist/blocks.js
init_compat_module();
...
// ../../node_modules/.bun/ts-dedent@2.2.0/node_modules/ts-dedent/esm/index.js
...
var V = /^ *:-+ *$/;
var H = /^ *-+: *$/;
var Q2 = (e2) => `(?=[\\s\\S]+?\\1${e2 ? "\\1" : ""})`;
var W = "((?:\\[.*?\\][([].*?[)\\]]|<.*?>(?:.*?<.*?>)?|`.*?`|\\\\\\1|[\\s\\S])+?)";
var J = RegExp(`^([*_])\\1${Q2(1)}${W}\\1\\1(?!\\1)`);
var K = RegExp(`^([*_])${Q2(0)}${W}\\1(?!\\1)`);
var X = RegExp(`^(==)${Q2(0)}${W}\\1`);
var Y = RegExp(`^(~~)${Q2(0)}${W}\\1`);
var ee = /^(:[a-zA-Z0-9-_]+:)/;
var ne = /^\\([^0-9A-Za-z\s])/;
...
`) !== -1 || s2 && u2;
      u2 = f2;
      let _22 = t2.inline, d22 = t2.list, p2;
...
function We(r2 = "", t = {}) {
  ...
  let l2 = t.slugify || Ae, G2 = t.sanitizer || De, U2 = t.createElement || _, V2 = [s, y2, h, t.enforceAtxHeadings ? z2 : S, E, M, ke, xe], H4 = [...V2, w, A2, B, O2];
  function Q22(e2, n2) {
...
`, { inline: n2 }));
  ...
  function ce2(e2, n2) {
    ...
    return r3 ? r3.reduce(function(n3, r4) {
      ...
      if (t2 !== -1) {
        let a2 = (function(e3) {
          return e3.indexOf("-") !== -1 && e3.match(L) === null && (e3 = e3.replace(T2, function(e4, n4) {
        ...
        typeof l3 == "string" && (A2.test(l3) || O2.test(l3)) && (n3[u2] = re2(l3.trim()));
      } else r4 !== "style" && (n3[o[r4] || r4] = true);
      return n3;
    }, {}) : null;
  }
  let ie2 = [], ue2 = {}, le2 = { 0: { t: [">"], o: Te(s), i: 1, u(e2, n2, r3) {
    let [, t2, o2] = e2[0].replace(f, "").match(_2);
  ...
  } }, 1: { t: ["  "], o: Me(d2), i: 1, u: Ue, l: (e2, n2, r3) => W2("br", { key: r3.key }) }, 2: { t: ["--", "__", "**", "- ", "* ", "_ "], o: Te(p), i: 1, u: Ue, l: (e2, n2, r3) => W2("hr", { key: r3.key }) }, 3: { t: ["    "], o: Te(h), i: 0, u: (e2) => ({ lang: void 0, text: Fe(Se(e2[0].replace(/^ {4}/gm, ""))) }), l: (e2, r3, t2) => W2("pre", { key: t2.key }, W2("code", n({}, e2.attrs, { className: e2.lang ? "lang-" + e2.lang : "" }), e2.text)) }, 4: { t: ["```", "~~~"], o: Te(y2), i: 0, u: (e2) => ({ attrs: ce2("code", e2[3] || ""), lang: e2[2] || void 0, text: e2[4], type: "3" }) }, 5: { t: ["`"], o: Ie(g), i: 3, u: (e2) => ({ text: Fe(e2[2]) }), l: (e2, n2, r3) => W2("code", { key: r3.key }, e2.text) }, 6: { t: ["[^"], o: Te(x3), i: 0, u: (e2) => (ie2.push({ footnote: e2[2], identifier: e2[1] }), {}), l: Ve }, 7: { t: ["[^"], o: Ce(q2), i: 1, u: (e2) => ({ target: "#" + l2(e2[1], Ae), text: e2[1] }), l: (e2, n2, r3) => W2("a", { key: r3.key, href: G2(e2.target, "a", "href") }, W2("sup", { key: r3.key }, e2.text)) }, 8: { t: ["[ ]", "[x]"], o: Ce($), i: 1, u: (e2) => ({ completed: e2[1].toLowerCase() === "x" }), l: (e2, n2, r3) => W2("input", { checked: e2.completed, key: r3.key, readOnly: true, type: "checkbox" }) }, 9: { t: ["#"], o: Te(t.enforceAtxHeadings ? z2 : S), i: 1, u: (e2, n2, r3) => ({ children: Pe(n2, e2[2], r3), id: l2(e2[2], Ae), level: e2[1].length }), l: (e2, n2, r3) => W2("h" + e2.level, { id: e2.id, key: r3.key }, n2(e2.children, r3)) }, 10: { t: (e2) => {
    let n2 = e2.indexOf(`
`);
    return n2 > 0 && n2 < e2.length - 1 && (e2[n2 + 1] === "=" || e2[n2 + 1] === "-");
  }, o: Te(E), i: 1, u: (e2, n2, r3) => ({ children: Pe(n2, e2[1], r3), level: e2[2] === "=" ? 1 : 2, type: "9" }) }, 11: { t: ["<"], o: Me(A2), i: 1, u(e2, n2, r3) {
    let [, t2] = e2[3].match(ae), o2 = RegExp("^" + t2, "gm"), a2 = e2[3].replace(o2, ""), i2 = Q22(H4, a2) ? Ne : Pe, u2 = e2[1].toLowerCase(), l3 = c.indexOf(u2) !== -1, s2 = (l3 ? u2 : e2[1]).trim(), f2 = { attrs: ce2(s2, e2[2]), noInnerParse: l3, tag: s2 };
  ...
  }, l: (e2, r3, t2) => W2(e2.tag, n({ key: t2.key }, e2.attrs), e2.text || (e2.children ? r3(e2.children, t2) : "")) }, 13: { t: ["<"], o: Me(O2), i: 1, u(e2) {
    let n2 = e2[1].trim();
...
var BooleanControl = ({
  ...
  var _a;
  let onSetFalse = q(() => onChange(false), [onChange]), readonly = !!((_a = argType == null ? void 0 : argType.table) == null ? void 0 : _a.readonly);
  if (value2 === void 0)
    return xn.createElement(
      Button,
      {
  ...
  return xn.createElement(Label, { "aria-disabled": readonly, htmlFor: controlId, "aria-label": name }, xn.createElement(
    "input",
    {
      id: controlId,
      type: "checkbox",
  ...
  ), xn.createElement("span", { "aria-hidden": "true" }, "False"), xn.createElement("span", { "aria-hidden": "true" }, "True"));
};
...
var DateControl = ({ name, value: value2, onChange, onFocus, onBlur, argType }) => {
  var _a;
  let [valid, setValid] = d(true), dateRef = A(), timeRef = A(), readonly = !!((_a = argType == null ? void 0 : argType.table) == null ? void 0 : _a.readonly);
  y(() => {
  ...
  return xn.createElement(FlexSpaced, null, xn.createElement("legend", { className: "sb-sr-only" }, name), xn.createElement("label", { htmlFor: `${controlId}-date`, className: "sb-sr-only" }, "Date"), xn.createElement(
    FormInput,
    {
      type: "date",
      max: "9999-12-31",
  ...
  ), xn.createElement("label", { htmlFor: `${controlId}-time`, className: "sb-sr-only" }, "Time"), xn.createElement(
    FormInput,
    {
      type: "time",
      id: `${controlId}-time`,
  ...
  ), valid ? null : xn.createElement("div", null, "invalid"));
};
...
var NumberControl = ({
  ...
  var _a;
  let [inputValue, setInputValue] = d(typeof value2 == "number" ? value2 : ""), [forceVisible, setForceVisible] = d(false), [parseError, setParseError] = d(null), readonly = !!((_a = argType == null ? void 0 : argType.table) == null ? void 0 : _a.readonly), handleChange = q(
    (event) => {
  ...
  return y(() => {
  ...
  }, [value2]), value2 === void 0 ? xn.createElement(
    Button,
    {
      ariaLabel: false,
      variant: "outline",
    ...
    "Set number"
  ) : xn.createElement(Wrapper2, null, xn.createElement(
    FormInput2,
    {
      ref: htmlElRef,
...
var CheckboxControl = ({
  ...
  var _a;
  if (!options)
    return import_client_logger2.logger.warn(`Checkbox with no options: ${name}`), xn.createElement(xn.Fragment, null, "-");
  let initial2 = selectedKeys(value2 || [], options), [selected, setSelected] = d(initial2), readonly = !!((_a = argType == null ? void 0 : argType.table) == null ? void 0 : _a.readonly), handleChange = (e2) => {
  ...
  return xn.createElement(Wrapper22, { $isInline: isInline }, xn.createElement("legend", { className: "sb-sr-only" }, name), Object.keys(options).map((key, index) => {
    let id = `${controlId}-${index}`;
    return xn.createElement(Label2, { key: id, htmlFor: id, $readOnly: readonly }, xn.createElement(
      "input",
      {
        type: "checkbox",
        disabled: readonly,
    ...
    ), xn.createElement(Text, { $readOnly: readonly }, key));
  }));
};
...
var RadioControl = ({
  ...
  var _a;
  if (!options)
    return import_client_logger3.logger.warn(`Radio with no options: ${name}`), xn.createElement(xn.Fragment, null, "-");
  ...
  return xn.createElement(Wrapper3, { isInline }, xn.createElement("legend", { className: "sb-sr-only" }, name), Object.keys(options).map((key, index) => {
    let id = `${controlId}-${index}`;
    return xn.createElement(Label3, { key: id, htmlFor: id, $readOnly: readonly }, xn.createElement(
      "input",
      {
        type: "radio",
        id,
    ...
    ), xn.createElement(Text2, { $readOnly: readonly }, key));
  }));
};
var styleResets = {
  // resets
...
var SingleSelect = ({ name, value: value2, options, onChange, argType }) => {
  ...
  return xn.createElement(SelectWrapper, null, xn.createElement(ChevronSmallDownIcon, null), xn.createElement("label", { htmlFor: controlId, className: "sb-sr-only" }, name), xn.createElement(OptionsSelect, { disabled: readonly, id: controlId, value: selection, onChange: handleChange }, xn.createElement("option", { disabled: selection === NO_SELECTION, key: "no-selection" }, NO_SELECTION), Object.keys(options).map((key) => xn.createElement("option", { key, value: key }, key))));
};
var MultiSelect = ({ name, value: value2, options, onChange, argType }) => {
  ...
  return xn.createElement(SelectWrapper, null, xn.createElement("label", { htmlFor: controlId, className: "sb-sr-only" }, name), xn.createElement(
    OptionsSelect,
    {
      disabled: readonly,
      id: controlId,
    ...
    Object.keys(options).map((key) => xn.createElement("option", { key, value: key }, key))
  ));
};
var SelectControl = (props) => {
  let { name, options } = props;
  return options ? props.isMulti ? xn.createElement(MultiSelect, { ...props }) : xn.createElement(SingleSelect, { ...props }) : (import_client_logger4.logger.warn(`Select with no options: ${name}`), xn.createElement(xn.Fragment, null, "-"));
};
...
var OptionsControl = (props) => {
  ...
  if (Control)
    return xn.createElement(Control, { ...normalized });
...
function JsonNodeAccordion({
  ...
  return xn.createElement(Container, { as: containerTag }, xn.createElement(
    Trigger,
    {
      type: "button",
...
var JsonAddValue = class extends x {
  ...
  render() {
    let {
      ...
      keyPath,
      deep
    } = this.props, addButtonElementLayout = addButtonElement && _n(addButtonElement, {
      onClick: this.onSubmit
    }), cancelButtonElementLayout = cancelButtonElement && _n(cancelButtonElement, {
      onClick: handleCancel
    }), inputElementValue = inputElementGenerator(VALUE, keyPath, deep), inputElementValueLayout = _n(inputElementValue, {
      placeholder: "Value",
    ...
    if (!onlyValue) {
      ...
      inputElementKeyLayout = _n(inputElementKey, {
        placeholder: "Key",
        ref: this.refInputKey,
        onKeyDown: this.onKeydown
      });
    }
    return xn.createElement("span", { className: "rejt-add-value-node" }, inputElementKeyLayout, inputElementValueLayout, addButtonElementLayout, cancelButtonElementLayout);
  }
};
JsonAddValue.defaultProps = {
  onlyValue: false,
  addButtonElement: xn.createElement("button", null, "+"),
  cancelButtonElement: xn.createElement("button", null, "c")
};
var JsonArray = class extends x {
  ...
  renderCollapsed() {
    let { name, data, keyPath, deep } = this.state, { handleRemove, readOnly, getStyle, dataType, minusMenuElement } = this.props, { minus, collapsed } = getStyle(name, data, keyPath, deep, dataType), isReadOnly = readOnly(name, data, keyPath, deep, dataType), removeItemButton = minusMenuElement && _n(minusMenuElement, {
      onClick: handleRemove,
      className: "rejt-minus-menu",
      style: minus,
      "aria-label": `remove the array '${String(name)}'`
    });
    return xn.createElement(xn.Fragment, null, xn.createElement("span", { style: collapsed }, "[...] ", data.length, " ", data.length === 1 ? "item" : "items"), !isReadOnly && removeItemButton);
  }
  renderNotCollapsed() {
    let { name, data, keyPath, deep, addFormVisible, nextDeep } = this.state, {
      ...
      logger: logger4,
      onSubmitValueParser
    } = this.props, { minus, plus, delimiter, ul, addForm } = getStyle(name, data, keyPath, deep, dataType), isReadOnly = readOnly(name, data, keyPath, deep, dataType), addItemButton = plusMenuElement && _n(plusMenuElement, {
      onClick: this.handleAddMode,
      className: "rejt-plus-menu",
      style: plus,
      "aria-label": `add a new item to the '${String(name)}' array`
    }), removeItemButton = minusMenuElement && _n(minusMenuElement, {
      onClick: handleRemove,
      className: "rejt-minus-menu",
      style: minus,
      "aria-label": `remove the array '${String(name)}'`
    });
    return xn.createElement(xn.Fragment, null, xn.createElement("span", { className: "rejt-not-collapsed-delimiter", style: delimiter }, "["), !addFormVisible && addItemButton, xn.createElement("ul", { className: "rejt-not-collapsed-list", style: ul }, data.map((item, index) => xn.createElement(
      JsonNode,
      {
        key: index,
        name: index.toString(),
    ...
    ))), !isReadOnly && addFormVisible && xn.createElement("div", { className: "rejt-add-form", style: addForm }, xn.createElement(
      JsonAddValue,
      {
    ...
    )), xn.createElement("span", { className: "rejt-not-collapsed-delimiter", style: delimiter }, "]"), !isReadOnly && removeItemButton);
  }
  render() {
...
JsonArray.defaultProps = {
  keyPath: [],
  deep: 0,
  minusMenuElement: xn.createElement("span", null, " - "),
  plusMenuElement: xn.createElement("span", null, " + ")
};
  ...
  render() {
    ...
    if (editEnabled && !resultOnlyResult) {
      let textareaElement = textareaElementGenerator(
        ...
        originalValue,
        dataType
      ), textareaElementLayout = _n(textareaElement, {
        ref: this.refInput,
        defaultValue: value2,
        onKeyDown: this.onKeydown
      });
      result = xn.createElement("span", { className: "rejt-edit-form", style: style.editForm }, textareaElementLayout), minusElement = null;
    } else {
      result = xn.createElement(
        "span",
        {
      ...
      let parentPropertyName = comeFromKeyPath.at(-1), minusMenuLayout = minusMenuElement && _n(minusMenuElement, {
        onClick: handleRemove,
        className: "rejt-minus-menu",
        style: style.minus,
    ...
    return xn.createElement("li", { className: "rejt-value-node", style: style.li }, xn.createElement("span", { className: "rejt-name", style: style.name }, name, " :", " "), result, minusElement);
  }
};
...
var JsonObject = class extends x {
  ...
  renderCollapsed() {
    ...
    return xn.createElement(xn.Fragment, null, xn.createElement("span", { style: collapsed }, "{...}", " ", keyList.length, " ", keyList.length === 1 ? "key" : "keys"), !isReadOnly && removeItemButton);
  }
  renderNotCollapsed() {
    let { name, data, keyPath, deep, nextDeep, addFormVisible } = this.state, {
      ...
      logger: logger4,
      onSubmitValueParser
    } = this.props, { minus, plus, addForm, ul, delimiter } = getStyle(name, data, keyPath, deep, dataType), keyList = Object.getOwnPropertyNames(data), isReadOnly = readOnly(name, data, keyPath, deep, dataType), addItemButton = plusMenuElement && _n(plusMenuElement, {
      onClick: this.handleAddMode,
      className: "rejt-plus-menu",
      style: plus,
      ...
      style: minus,
      "aria-label": `remove the object '${String(name)}'`
    }), list = keyList.map((key) => xn.createElement(
      JsonNode,
      {
        key,
        name: key,
    ...
    return xn.createElement(xn.Fragment, null, xn.createElement("span", { className: "rejt-not-collapsed-delimiter", style: delimiter }, "{"), !isReadOnly && addItemButton, xn.createElement("ul", { className: "rejt-not-collapsed-list", style: ul }, list), !isReadOnly && addFormVisible && xn.createElement("div", { className: "rejt-add-form", style: addForm }, xn.createElement(
      JsonAddValue,
      {
        handleAdd: this.handleAddValueAdd,
        handleCancel: this.handleAddValueCancel,
...
var JsonValue = class extends x {
  ...
  render() {
    let { name, value: value2, editEnabled, keyPath, deep } = this.state, {
      ...
      originalValue,
      dataType
    ), inputElementLayout = _n(inputElement, {
      ref: this.refInput,
      defaultValue: JSON.stringify(originalValue),
      onKeyDown: this.onKeydown
    }), parentPropertyName = keyPath.at(-2), minusMenuLayout = minusMenuElement && _n(minusMenuElement, {
      onClick: handleRemove,
      className: "rejt-minus-menu",
      style: style.minus,
    ...
    return xn.createElement("li", { className: "rejt-value-node", style: style.li }, xn.createElement("span", { className: "rejt-name", style: style.name }, name, " : "), isEditing ? xn.createElement("span", { className: "rejt-edit-form", style: style.editForm }, inputElementLayout) : xn.createElement(
      "span",
      {
        className: "rejt-value",
        style: style.value,
...
var JsonTree = class extends x {
  ...
  render() {
    ...
    return textareaElement && getObjectType(textareaElement) !== "Function" && (textareaElementFunction = () => textareaElement), dataType === "Object" || dataType === "Array" ? xn.createElement("div", { className: "rejt-tree" }, xn.createElement(
      JsonNode,
      {
        data,
        name: rootName || "root",
...
JsonTree.defaultProps = {
  ...
  inputElement: () => xn.createElement("input", null),
  textareaElement: () => xn.createElement("textarea", null),
  fallback: null
};
...
var ObjectControl = ({ name, value: value2, onChange, argType }) => {
  var _a;
  let theme = useTheme(), data = T(() => value2 && cloneDeep(value2), [value2]), hasData = data != null, [showRaw, setShowRaw] = d(!hasData), [parseError, setParseError] = d(null), readonly = !!((_a = argType == null ? void 0 : argType.table) == null ? void 0 : _a.readonly), updateRaw = q(
    (raw) => {
      try {
    ...
    [onChange]
  ), [forceVisible, setForceVisible] = d(false), onForceVisible = q(() => {
    onChange({}), setForceVisible(true);
  }, [setForceVisible]), htmlElRef = A(null);
  y(() => {
    forceVisible && htmlElRef.current && htmlElRef.current.select();
  }, [forceVisible]);
  let jsonString = T(() => JSON.stringify(data ?? "", null, 2), [data]);
  if (!hasData)
    return xn.createElement(
      Button,
      {
  ...
  let rawJSONForm = xn.createElement(
    RawInput,
    {
      ref: htmlElRef,
      id: getControlId(name),
  ...
  return xn.createElement(Wrapper4, null, isObjectOrArray && xn.createElement(
    RawButton,
    {
      disabled: readonly,
      pressed: showRaw,
    ...
    "Edit JSON"
  ), showRaw ? rawJSONForm : xn.createElement(
    JsonTree,
    {
      ...
      cancelButtonElement: xn.createElement(ButtonInline, { type: "button" }, "Cancel"),
      addButtonElement: xn.createElement(ButtonInline, { type: "submit", primary: true }, "Save"),
      plusMenuElement: xn.createElement(ActionButton, { type: "button" }, xn.createElement(AddIcon, null)),
      minusMenuElement: xn.createElement(ActionButton, { type: "button" }, xn.createElement(SubtractIcon, null)),
      inputElement: (_22, __, ___, key) => key ? xn.createElement(Input, { onFocus: selectValue, onBlur: dispatchEnterKey }) : xn.createElement(Input, null),
...
var RangeControl = ({
  ...
  }, hasValue = value2 !== void 0, numberOFDecimalsPlaces = T(() => getNumberOfDecimalPlaces(step), [step]), readonly = !!((_a = argType == null ? void 0 : argType.table) == null ? void 0 : _a.readonly), controlId = getControlId(name);
  return xn.createElement(RangeWrapper, { readOnly: readonly }, xn.createElement("label", { htmlFor: controlId, className: "sb-sr-only" }, name), xn.createElement(RangeLabel, null, min), xn.createElement(
    RangeInput,
    {
      id: controlId,
      type: "range",
  ...
  ), xn.createElement(RangeCurrentAndMaxLabel, { numberOFDecimalsPlaces, max }, hasValue ? value2.toFixed(numberOFDecimalsPlaces) : "--", " / ", max));
};
...
var TextControl = ({
  ...
  }, readonly = !!((_a = argType == null ? void 0 : argType.table) == null ? void 0 : _a.readonly), [forceVisible, setForceVisible] = d(false), onForceVisible = q(() => {
    onChange(""), setForceVisible(true);
  }, [setForceVisible]);
  if (value2 === void 0)
    return xn.createElement(
  ...
  return xn.createElement(Wrapper5, null, xn.createElement(
    Form.Textarea,
    {
      id: getControlId(name),
      maxLength,
  ...
  ), maxLength && xn.createElement(MaxLength, { isMaxed: (value2 == null ? void 0 : value2.length) === maxLength }, (value2 == null ? void 0 : value2.length) ?? 0, " / ", maxLength));
};
...
var FilesControl = ({
  ...
  var _a;
  let inputElement = A(null), readonly = (_a = argType == null ? void 0 : argType.control) == null ? void 0 : _a.readOnly;
  ...
  let controlId = getControlId(name);
  return xn.createElement(xn.Fragment, null, xn.createElement("label", { htmlFor: controlId, className: "sb-sr-only" }, name), xn.createElement(
    FileInput,
    {
      ref: inputElement,
      id: controlId,
...
var LazyColorControl = z(() => import("./Color-6BZIO3FS-5L52MXCX.js"));
var ColorControl = (props) => xn.createElement(P, { fallback: xn.createElement("div", null) }, xn.createElement(LazyColorControl, { ...props }));
var Controls2 = {
  array: ObjectControl,
...
var NoControl = () => xn.createElement(xn.Fragment, null, "-");
...
var ArgJsDoc = ({ tags }) => {
  ...
  return !hasDisplayableParams && !hasDisplayableReturns && !hasDisplayableDeprecated ? null : xn.createElement(xn.Fragment, null, xn.createElement(Table, null, xn.createElement("tbody", null, hasDisplayableDeprecated && xn.createElement("tr", { key: "deprecated" }, xn.createElement("td", { colSpan: 2 }, xn.createElement("strong", null, "Deprecated"), ": ", (_a = tags.deprecated) == null ? void 0 : _a.toString())), hasDisplayableParams && params.map((x22) => xn.createElement("tr", { key: x22.name }, xn.createElement("td", null, xn.createElement("code", null, x22.name)), xn.createElement("td", null, x22.description))), hasDisplayableReturns && xn.createElement("tr", { key: "returns" }, xn.createElement("td", null, xn.createElement("code", null, "Returns")), xn.createElement("td", null, (_b = tags.returns) == null ? void 0 : _b.description)))));
};
function uniq(arr) {
  return [...new Set(arr)];
}
...
var EmptyArg = () => xn.createElement("span", null, "-");
var ArgText = ({ text, simple }) => xn.createElement(Text3, { simple }, text);
...
var renderSummaryItems = (summaryItems) => summaryItems.slice(0, ITEMS_BEFORE_EXPANSION).map((item) => xn.createElement(ArgText, { key: item, text: item === "" ? '""' : item }));
var renderExpandedItems = (summaryItems) => summaryItems.slice(ITEMS_BEFORE_EXPANSION).map((item) => xn.createElement(ArgText, { key: item, text: item === "" ? '""' : item }));
var ArgSummary = ({ value: value2, initialExpandedArgs }) => {
  ...
  if (detail == null) {
    if (/[(){}[\]<>]/.test(summaryAsString))
      return xn.createElement(ArgText, { text: summaryAsString });
    let summaryItems = getSummaryItems(summaryAsString), itemsCount = summaryItems.length;
    return itemsCount > ITEMS_BEFORE_EXPANSION ? xn.createElement(Summary, { isExpanded }, renderSummaryItems(summaryItems), xn.createElement(DetailsContainer, { open: isExpanded, onToggle: (e2) => setIsExpanded(e2.currentTarget.open) }, xn.createElement(AlignedDetails, null, renderExpandedItems(summaryItems)), xn.createElement(ExpandButton, { role: "button" }, isExpanded ? "Show less..." : `Show ${itemsCount - ITEMS_BEFORE_EXPANSION} more...`))) : xn.createElement(Summary, null, renderSummaryItems(summaryItems));
  }
  return xn.createElement(
    PopoverProvider,
    {
      ...
      hasCloseButton: true,
      popover: xn.createElement(Detail, null, xn.createElement(SyntaxHighlighter, { language: "jsx", format: false }, detail))
    },
    xn.createElement(Expandable, { className: "sbdocs-expandable" }, xn.createElement("span", null, summaryAsString), isOpen ? xn.createElement(ChevronUpIcon, null) : xn.createElement(ChevronDownIcon2, null))
  );
};
var ArgValue = ({ value: value2, initialExpandedArgs }) => value2 == null ? xn.createElement(EmptyArg, null) : xn.createElement(ArgSummary, { value: value2, initialExpandedArgs });
...
var ArgRow = (props) => {
  var _a;
  let [isHovered, setIsHovered] = d(false), { row, updateArgs, compact: compact2, expandable, initialExpandedArgs } = props, { name, description } = row, table = row.table || {}, type = table.type || toSummary(row.type), defaultValue = table.defaultValue || row.defaultValue, required = (_a = row.type) == null ? void 0 : _a.required, hasDescription = description != null && description !== "";
  return xn.createElement("tr", { onMouseEnter: () => setIsHovered(true), onMouseLeave: () => setIsHovered(false) }, xn.createElement(StyledTd, { expandable: expandable ?? false }, xn.createElement(Name, null, name), required ? xn.createElement(Required, { title: "Required" }, "*") : null), compact2 ? null : xn.createElement("td", null, hasDescription && xn.createElement(Description, null, xn.createElement(index_modern_default, null, description)), table.jsDocTags != null ? xn.createElement(xn.Fragment, null, xn.createElement(TypeWithJsDoc, { hasDescription }, xn.createElement(ArgValue, { value: type, initialExpandedArgs })), xn.createElement(ArgJsDoc, { tags: table.jsDocTags })) : xn.createElement(Type, { hasDescription }, xn.createElement(ArgValue, { value: type, initialExpandedArgs }))), compact2 ? null : xn.createElement("td", null, xn.createElement(ArgValue, { value: defaultValue, initialExpandedArgs })), updateArgs ? xn.createElement("td", null, xn.createElement(ArgControl, { ...props, isHovered })) : null);
};
...
var Empty = ({ inAddonPanel }) => {
  ...
  }, []), isLoading ? null : xn.createElement(Wrapper6, { inAddonPanel }, xn.createElement(
    EmptyTabContent,
    {
      title: inAddonPanel ? "Interactive story playground" : "Args table with interactive controls couldn't be auto-generated",
      description: xn.createElement(xn.Fragment, null, "Controls give you an easy to use interface to test your components. Set your story args and you'll see controls appearing here automatically."),
      footer: xn.createElement(Links, null, inAddonPanel && xn.createElement(xn.Fragment, null, xn.createElement(
        Link2,
        {
          href: "https://storybook.js.org/docs/essentials/controls?ref=ui",
          target: "_blank",
        ...
        xn.createElement(DocumentIcon, null),
        " Read docs"
      )), !inAddonPanel && xn.createElement(
        Link2,
        {
          href: "https://storybook.js.org/docs/essentials/controls?ref=ui",
          target: "_blank",
...
var SectionRow = ({
  ...
  let [expanded, setExpanded] = d(initialExpanded), Level = level === "subsection" ? Subsection : Section, itemCount = (children == null ? void 0 : children.length) || 0, caption = level === "subsection" ? `${itemCount} item${itemCount !== 1 ? "s" : ""}` : "", helperText = `${expanded ? "Hide" : "Show"} ${level === "subsection" ? itemCount : label} item${itemCount !== 1 ? "s" : ""}`;
  return xn.createElement(xn.Fragment, null, xn.createElement(StyledTr, { title: helperText }, xn.createElement(Level, { colSpan: 1 }, xn.createElement(ClickIntercept, { onClick: (e2) => setExpanded(!expanded), tabIndex: 0 }, helperText), xn.createElement(FlexWrapper, null, expanded ? xn.createElement(ExpanderIconDown, null) : xn.createElement(ExpanderIconRight, null), label)), xn.createElement(StyledTd2, { colSpan: colSpan - 1 }, xn.createElement(
    ClickIntercept,
    {
...
var Skeleton = () => xn.createElement(TableWrapper, null, xn.createElement(Row, null, xn.createElement(Column, { position: "first" }, xn.createElement(SkeletonText, { width: "60%" })), xn.createElement(Column, { position: "second" }, xn.createElement(SkeletonText, { width: "30%" })), xn.createElement(Column, { position: "third" }, xn.createElement(SkeletonText, { width: "60%" })), xn.createElement(Column, { position: "last" }, xn.createElement(SkeletonText, { width: "60%" }))), xn.createElement(Row, null, xn.createElement(Column, { position: "first" }, xn.createElement(SkeletonText, { width: "60%" })), xn.createElement(Column, { position: "second" }, xn.createElement(SkeletonText, { width: "80%" }), xn.createElement(SkeletonText, { width: "30%" })), xn.createElement(Column, { position: "third" }, xn.createElement(SkeletonText, { width: "60%" })), xn.createElement(Column, { position: "last" }, xn.createElement(SkeletonText, { width: "60%" }))), xn.createElement(Row, null, xn.createElement(Column, { position: "first" }, xn.createElement(SkeletonText, { width: "60%" })), xn.createElement(Column, { position: "second" }, xn.createElement(SkeletonText, { width: "80%" }), xn.createElement(SkeletonText, { width: "30%" })), xn.createElement(Column, { position: "third" }, xn.createElement(SkeletonText, { width: "60%" })), xn.createElement(Column, { position: "last" }, xn.createElement(SkeletonText, { width: "60%" }))), xn.createElement(Row, null, xn.createElement(Column, { position: "first" }, xn.createElement(SkeletonText, { width: "60%" })), xn.createElement(Column, { position: "second" }, xn.createElement(SkeletonText, { width: "80%" }), xn.createElement(SkeletonText, { width: "30%" })), xn.createElement(Column, { position: "third" }, xn.createElement(SkeletonText, { width: "60%" })), xn.createElement(Column, { position: "last" }, xn.createElement(SkeletonText, { width: "60%" }))));
...
var ArgsTable = (props) => {
  ...
  if ("error" in props) {
    let { error } = props;
    return xn.createElement(EmptyBlock, null, error, " ", xn.createElement(Link2, { href: "http://storybook.js.org/docs/?ref=ui", target: "_blank", withArrow: true }, xn.createElement(DocumentIcon, null), " Read the docs"));
  }
  if (isLoading)
    return xn.createElement(Skeleton, null);
  ...
  if (hasNoUngrouped && hasNoSections && hasNoUngroupedSubsections)
    return xn.createElement(Empty, { inAddonPanel });
  let colSpan = 1;
  ...
  return xn.createElement(ResetWrapper, null, xn.createElement(TablePositionWrapper, null, updateArgs && !isLoading && resetArgs && xn.createElement(ButtonPositionWrapper, null, xn.createElement(
    StyledButton,
    {
      variant: "ghost",
      padding: "small",
    ...
    xn.createElement(UndoIcon, null)
  )), xn.createElement(
    TableWrapper2,
    {
      compact: compact2,
    ...
    xn.createElement("thead", { className: "docblock-argstable-head" }, xn.createElement("tr", null, xn.createElement("th", null, xn.createElement("span", null, "Name")), compact2 ? null : xn.createElement("th", null, xn.createElement("span", null, "Description")), compact2 ? null : xn.createElement("th", null, xn.createElement("span", null, "Default")), updateArgs ? xn.createElement("th", null, xn.createElement("span", null, "Control")) : null)),
    xn.createElement("tbody", { className: "docblock-argstable-body" }, groups.ungrouped.map((row) => xn.createElement(ArgRow, { key: row.key, row, arg: args && args[row.key], ...common })), Object.entries(groups.ungroupedSubsections).map(([subcategory, subsection]) => xn.createElement(
      SectionRow,
      {
        key: subcategory,
        label: subcategory,
      ...
      subsection.map((row) => xn.createElement(
        ArgRow,
        {
          key: row.key,
          row,
    ...
    )), Object.entries(groups.sections).map(([category, section]) => xn.createElement(SectionRow, { key: category, label: category, level: "section", colSpan }, section.ungrouped.map((row) => xn.createElement(ArgRow, { key: row.key, row, arg: args && args[row.key], ...common })), Object.entries(section.subsections).map(([subcategory, subsection]) => xn.createElement(
      SectionRow,
      {
        key: subcategory,
        label: subcategory,
...
var DocsPageWrapper = ({ children, toc }) => xn.createElement(DocsWrapper, { className: "sbdocs sbdocs-wrapper" }, toc, xn.createElement(DocsContent, { className: "sbdocs sbdocs-content" }, children));
...
var Story2 = (props = { __forceInitialArgs: false, __primary: false }) => {
  let context = x2(DocsContext), storyId = getStoryId(props, context), story = useStory(storyId, context);
  if (!story)
    return xn.createElement(StorySkeleton, null);
  let storyProps = getStoryProps(props, story, context);
  return storyProps ? xn.createElement(Story, { ...storyProps }) : null;
};
...
var InlineStory = (props) => {
  ...
  }, [autoplay, renderStoryToElement, story]), error ? xn.createElement("pre", null, xn.createElement(ErrorFormatter, { error })) : xn.createElement(xn.Fragment, null, height ? xn.createElement("style", null, `#${storyBlockIdFromId(
    props
  )} { min-height: ${height}; transform: translateZ(0); overflow: auto }`) : null, showLoader && xn.createElement(StorySkeleton, null), xn.createElement("div", { ref: storyRef, id: `${storyBlockIdFromId(props)}-inner`, "data-name": story.name }));
};
var IFrameStory = ({ story, height = "500px" }) => xn.createElement("div", { style: { width: "100%", height } }, xn.createElement(ZoomContext.Consumer, null, ({ scale }) => xn.createElement(
  IFrame,
  {
    key: "iframe",
    id: `iframe--${story.id}`,
...
var Story = (props) => {
  ...
  return inline && !props.autoplay && story.usesMount ? xn.createElement(ErrorMessage, null, "This story mounts inside of play. Set", " ", xn.createElement("a", { href: "https://storybook.js.org/docs/api/doc-blocks/doc-block-story?ref=ui#autoplay" }, "autoplay"), " ", "to true to view this story.") : xn.createElement("div", { id: storyBlockIdFromId(props), className: "sb-story sb-unstyled", "data-story-block": "true" }, inline ? xn.createElement(InlineStory, { ...props }) : xn.createElement(IFrameStory, { ...props }));
};
var StorySkeleton = () => xn.createElement(Loader, null);
...
var Toolbar2 = ({ isLoading, storyId, zoom, resetZoom, ...rest }) => xn.createElement(AbsoluteBar, { innerStyle: { gap: 4, paddingInline: 7, justifyContent: "space-between" }, ...rest }, xn.createElement(Wrapper7, { key: "left" }, isLoading ? [1, 2, 3].map((key) => xn.createElement(IconPlaceholder, { key })) : xn.createElement(xn.Fragment, null, xn.createElement(
  Button,
  {
    padding: "small",
    variant: "ghost",
  ...
  xn.createElement(ZoomIcon, null)
), xn.createElement(
  Button,
  {
    padding: "small",
  ...
  xn.createElement(ZoomOutIcon, null)
), xn.createElement(
  Button,
  {
    padding: "small",
  ...
  xn.createElement(ZoomResetIcon, null)
))), isLoading ? xn.createElement(Wrapper7, { key: "right" }, xn.createElement(IconPlaceholder, null)) : storyId && xn.createElement(Wrapper7, { key: "right" }, xn.createElement(
  Button,
  {
    asChild: true,
    padding: "small",
  ...
  xn.createElement("a", { href: getStoryHref(storyId), target: "_blank", rel: "noopener noreferrer" }, xn.createElement(ShareAltIcon, null))
)));
...
var getSource = (withSource, expanded, setExpanded) => {
  switch (true) {
    ...
    case expanded:
      return {
        source: xn.createElement(StyledSource, { ...withSource, dark: true }),
        actionItem: {
          title: "Hide code",
...
var Preview = ({
  ...
  let [expanded, setExpanded] = d(isExpanded), { source, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = d(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = d(
    additionalActions ? [...additionalActions] : []
  ), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = globalThis, context = x2(DocsContext), copyToClipboard = q(async (text) => {
    let { createCopyToClipboardFunction } = await import("./components-OUYLBK3Q.js");
  ...
  return xn.createElement(
    ...
    xn.createElement(ZoomContext.Provider, { value: { scale } }, xn.createElement(Relative, { className: "docs-story", onCopyCapture: withSource && onCopyCapture }, xn.createElement(
      ChildrenContainer,
      {
      ...
      xn.createElement(Zoom.Element, { centered: layout === "centered", scale: inline ? scale : 1 }, Array.isArray(children) ? children.map((child, i2) => xn.createElement("div", { key: i2 }, child)) : xn.createElement("div", null, children))
    ), xn.createElement(ActionBar, { actionItems }))),
...
var TabbedArgsTable = ({ tabs, ...props }) => {
  ...
  if (entries.length === 1)
    return xn.createElement(ArgsTable, { ...entries[0][1], ...props });
  let tabsFromEntries = entries.map(([label, table], index) => ({
    ...
    children: () => {
      ...
      return xn.createElement(ArgsTable, { inTabPanel: true, key: `prop_table_${label}`, ...table, ...argsTableProps });
    }
  }));
  return xn.createElement(StyledTabsView, { tabs: tabsFromEntries });
};
...
var Typeset = ({
  ...
  sampleText,
  ...props
}) => xn.createElement(Wrapper8, { ...props, className: "docblock-typeset sb-unstyled" }, fontSizes.map((size) => xn.createElement(TypeSpecimen, { key: size }, xn.createElement(Label4, null, size), xn.createElement(
  Sample,
  {
    style: {
      fontFamily,
...
function renderSwatch(color, index) {
  return xn.createElement(Swatch, { key: `${color}-${index}`, title: color, background: color });
}
function renderSwatchLabel(color, index, colorDescription) {
  return xn.createElement(SwatchLabel, { key: `${color}-${index}`, title: color }, xn.createElement("div", null, color, colorDescription && xn.createElement("span", null, colorDescription)));
}
function renderSwatchSpecimen(colors) {
  if (Array.isArray(colors))
    return xn.createElement(SwatchSpecimen, null, xn.createElement(SwatchColors, null, colors.map((color, index) => renderSwatch(color, index))), xn.createElement(SwatchLabels, null, colors.map((color, index) => renderSwatchLabel(color, index))));
  ...
  return xn.createElement(SwatchSpecimen, null, xn.createElement(SwatchColors, null, swatchElements), xn.createElement(SwatchLabels, null, labelElements));
}
var ColorItem = ({ title, subtitle, colors }) => xn.createElement(Item, null, xn.createElement(ItemDescription, null, xn.createElement(ItemTitle, null, title), xn.createElement(ItemSubtitle, null, subtitle)), xn.createElement(Swatches, null, renderSwatchSpecimen(colors)));
var ColorPalette = ({ children, ...props }) => xn.createElement(ResetWrapper, null, xn.createElement(List, { ...props, className: "docblock-colorpalette sb-unstyled" }, xn.createElement(ListHeading, null, xn.createElement(ListName, null, "Name"), xn.createElement(ListSwatches, null, "Swatches")), children));
...
var IconItem = ({ name, children }) => xn.createElement(Item2, null, xn.createElement(ItemSpecimen, null, children), xn.createElement(ItemLabel, null, name));
var IconGallery = ({ children, ...props }) => xn.createElement(ResetWrapper, null, xn.createElement(List2, { ...props, className: "docblock-icongallery sb-unstyled" }, children));
...
function jump(target, options) {
  ...
  function easeInOutQuad(t, b2, c2, d22) {
    return t /= d22 / 2, t < 1 ? c2 / 2 * t * t + b2 : (t--, -c2 / 2 * (t * (t - 2) - 1) + b2);
  }
}
...
var Title2 = ({ headingId, title }) => typeof title == "string" || !title ? xn.createElement(Heading, { as: "h2", id: headingId, className: title ? "" : "sb-sr-only" }, title || "Table of contents") : xn.createElement("div", { id: headingId }, title);
var TableOfContents = ({
  title,
  disable,
  headingSelector,
  ...
  return xn.createElement(Aside, { className }, disable ? null : xn.createElement(Nav, { "aria-labelledby": headingId }, xn.createElement(Title2, { headingId, title }), xn.createElement("div", { className: "toc-wrapper" })));
};
var anchorBlockIdFromId = (storyId) => `anchor--${storyId}`;
var Anchor = ({ storyId, children }) => xn.createElement("div", { id: anchorBlockIdFromId(storyId), className: "sb-anchor" }, children);
...
var ArgTypes = (props) => {
  ...
  if (!(!!subcomponents && Object.keys(subcomponents || {}).length > 0))
    return xn.createElement(ArgsTable, { rows: filteredArgTypes, sort });
  ...
  return xn.createElement(TabbedArgsTable, { tabs, sort });
};
...
var require_get_proto = __commonJS2({
  "node_modules/.pnpm/get-proto@1.0.1/node_modules/get-proto/index.js"(exports, module) {
    ...
    module.exports = reflectGetProto ? function(O22) {
      ...
      if (!O22 || typeof O22 != "object" && typeof O22 != "function")
...
var SourceContainer = ({
  ...
  }, []), xn.createElement(SourceContext.Provider, { value: { sources } }, children);
};
function useTransformCode(source, transform, storyContext) {
  let [transformedCode, setTransformedCode] = d("Transforming..."), transformed = transform ? transform == null ? void 0 : transform(source, storyContext) : source;
  return y(() => {
...
var Source2 = (props) => {
  ...
  return xn.createElement(Source, { ...sourceProps });
};
var Canvas = (props) => {
  ...
  return xn.createElement(
    ...
    xn.createElement(Story2, { of: of || story.moduleExport, meta: props.meta, ...props.story })
  );
};
...
var usePrimaryStory = () => x2(DocsContext).componentStories().find((story) => story.tags.includes(import_preview_api3.Tag.AUTODOCS));
...
var Controls3 = (props) => {
  var _a;
  let { of } = props, context = x2(DocsContext), primaryStory = usePrimaryStory(), story = of ? context.resolveOf(of, ["story"]).story : primaryStory;
  if (!story)
    return null;
  ...
  if (!(!!subcomponents && Object.keys(subcomponents || {}).length > 0))
    return Object.keys(filteredArgTypes).length > 0 || Object.keys(args).length > 0 ? xn.createElement(
      ArgsTable,
      {
...
var AddContext = (props) => {
  let { children, ...rest } = props, parentContext = xn.useContext(DocsContext);
  return xn.createElement(DocsContext.Provider, { value: { ...parentContext, ...rest } }, children);
};
var CodeOrSourceMdx = ({
  className,
  children,
  ...
  if (typeof className != "string" && (typeof children != "string" || !children.match(/[\n\r]/g)))
    return xn.createElement(Code, null, children);
...
var AnchorMdx = (props) => {
  ...
  return !href || target === "_blank" || /^https?:\/\//.test(href) ? xn.createElement(A22, { ...props }) : href.startsWith("#") ? xn.createElement(AnchorInPage, { hash: href }, children) : xn.createElement(
    A22,
    {
      href,
      onClick: (event) => {
...
var HeaderWithOcticonAnchor = ({
  ...
  return xn.createElement(OcticonHeader, { id, ...rest }, xn.createElement(
    OcticonAnchor,
    {
      "aria-hidden": "true",
      href: hash,
    ...
    xn.createElement(LinkIcon, null)
  ), children);
};
var HeaderMdx = (props) => {
  let { as, id, children, ...rest } = props;
  if (id)
    return xn.createElement(HeaderWithOcticonAnchor, { as, id, ...rest }, children);
  let Component4 = as, { as: omittedAs, ...withoutAs } = props;
  return xn.createElement(Component4, { ...nameSpaceClassNames(withoutAs, as) });
};
var HeadersMdx = SUPPORTED_MDX_HEADERS.reduce(
  (acc, headerType) => ({
    ...acc,
    // @ts-expect-error (Converted from ts-ignore)
    [headerType]: (props) => xn.createElement(HeaderMdx, { as: headerType, ...props })
  }),
  {}
);
var Markdown = (props) => {
...
var DescriptionContainer = (props) => {
  ...
  return markdown ? xn.createElement(Markdown, null, markdown) : null;
};
...
var DocsContainer = ({
  ...
  }), xn.createElement(DocsContext.Provider, { value: context }, xn.createElement(SourceContainer, { channel: context.channel }, xn.createElement(ThemeProvider, { theme: ensure(theme) }, xn.createElement(
    DocsPageWrapper,
    {
      toc: toc ? xn.createElement(
        TableOfContents,
        {
...
var Heading2 = ({
  ...
  if (disableAnchor || typeof children != "string")
    return xn.createElement(H2, null, children);
  let tagID = slugs.slug(children.toLowerCase());
  return xn.createElement(HeaderMdx, { as: "h2", id: tagID, ...props }, children);
};
var Subheading = ({ children, disableAnchor }) => {
  if (disableAnchor || typeof children != "string")
    return xn.createElement(H3, null, children);
  let tagID = slugs.slug(children.toLowerCase());
  return xn.createElement(HeaderMdx, { as: "h3", id: tagID }, children);
};
var DocsStory = ({
  of,
  expanded = true,
  ...
  return xn.createElement(Anchor, { storyId: __primary ? `primary--${story.id}` : story.id }, expanded && xn.createElement(xn.Fragment, null, xn.createElement(Subheading, null, story.name), xn.createElement(DescriptionContainer, { of })), xn.createElement(
    Canvas,
    {
      of,
      withToolbar,
...
var Primary = () => {
  ...
  return primaryStory ? xn.createElement(DocsStory, { of: primaryStory.moduleExport, expanded: false, __primary: true, withToolbar: true }) : null;
};
...
var Stories = ({ title = "Stories", includePrimary = true }) => {
  var _a;
  let { componentStories, projectAnnotations, getStoryContext } = x2(DocsContext), stories = componentStories(), { stories: { filter } = { filter: void 0 } } = ((_a = projectAnnotations.parameters) == null ? void 0 : _a.docs) || {};
  ...
  })), includePrimary || (stories = stories.slice(1)), !stories || stories.length === 0 ? null : xn.createElement(xn.Fragment, null, typeof title == "string" ? xn.createElement(StyledHeading, null, title) : title, stories.map(
    (story) => story && xn.createElement(DocsStory, { key: story.id, of: story.moduleExport, expanded: true, __forceInitialArgs: true })
  ));
};
...
var Subtitle2 = (props) => {
  ...
  return content ? xn.createElement(Subtitle, { className: "sbdocs-subtitle sb-unstyled" }, content) : null;
};
...
var Title3 = (props) => {
  ...
  return content ? xn.createElement(Title, { className: "sbdocs-title sb-unstyled" }, content) : null;
};
var DocsPage = () => {
  let resolvedOf = useOf("meta", ["meta"]), { stories } = resolvedOf.csfFile, isSingleStory = Object.keys(stories).length === 1;
  return xn.createElement(xn.Fragment, null, xn.createElement(Title3, null), xn.createElement(Subtitle2, null), xn.createElement(DescriptionContainer, { of: "meta" }), isSingleStory ? xn.createElement(DescriptionContainer, { of: "story" }) : null, xn.createElement(Primary, null), xn.createElement(Controls3, null), isSingleStory ? null : xn.createElement(Stories, null));
};
function Docs({
  context,
  docsParameter
  ...
  return xn.createElement(Container2, { context, theme: docsParameter.theme }, xn.createElement(Page, null));
}
...
function ExternalDocs({
  ...
  return xn.createElement(Docs, { docsParameter, context: preview2.docsContext() });
}
var preview;
var ExternalDocsContainer = ({ projectAnnotations, children }) => (preview || (preview = new ExternalPreview(projectAnnotations)), xn.createElement(DocsContext.Provider, { value: preview.docsContext() }, xn.createElement(ThemeProvider, { theme: ensure(themes.light) }, children)));
var Meta = ({ of }) => {
  let context = x2(DocsContext);
  of && context.referenceMeta(of, true);
  try {
    let primary = context.storyById();
    return xn.createElement(Anchor, { storyId: primary.id });
  } catch {
    return null;
  }
};
var Unstyled = (props) => xn.createElement("div", { ...props, className: "sb-unstyled" });
var Wrapper9 = ({ children }) => xn.createElement("div", { style: { fontFamily: "sans-serif" } }, children);
var PRIMARY_STORY = "^";
...
//# sourceMappingURL=chunk-QJKAHSBI.js.map
