...
// ../../node_modules/.bun/embla-carousel-react@8.6.0+b1ab299f0a400331/node_modules/embla-carousel-react/esm/embla-carousel-react.esm.js
init_compat_module();
...
function useEmblaCarousel(options = {}, plugins = []) {
  const storedOptions = A(options);
  const storedPlugins = A(plugins);
  const [emblaApi, setEmblaApi] = d();
  const [viewport, setViewport] = d();
  const reInit = q(() => {
