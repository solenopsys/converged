...
init_compat_module();
var NAME = "Arrow";
var Arrow = D((props, forwardedRef) => {
  ...
  return u(
    Primitive.svg,
    {
      ...
      children: props.asChild ? children : u("polygon", { points: "0,0 30,0 15,10" })
    }
  );
});
...
var Popper = (props) => {
  ...
  return u(PopperProvider, { scope: __scopePopper, anchor, onAnchorChange: setAnchor, children });
};
...
var PopperAnchor = D(
  (props, forwardedRef) => {
    ...
    return virtualRef ? null : u(Primitive.div, { ...anchorProps, ref: composedRefs });
  }
);
...
//# sourceMappingURL=chunk-FQJKPTP4.js.map
