import {
  keysFromSelector
} from "./chunk-7Z6TFX4T.js";
import {
  require_shim
} from "./chunk-JAUQNMSB.js";
import {
  D,
  O,
  _n,
...
// ../../node_modules/.bun/void-elements@3.1.0/node_modules/void-elements/index.js
var require_void_elements = __commonJS({
  "../../node_modules/.bun/void-elements@3.1.0/node_modules/void-elements/index.js"(exports, module) {
    module.exports = {
      "area": true,
      "base": true,
      "br": true,
...
// ../../node_modules/.bun/react-i18next@16.5.4+a15ca22a091ca6fb/node_modules/react-i18next/dist/es/Trans.js
init_compat_module();

// ../../node_modules/.bun/react-i18next@16.5.4+a15ca22a091ca6fb/node_modules/react-i18next/dist/es/TransWithoutContext.js
init_compat_module();

// ../../node_modules/.bun/html-parse-stringify@3.0.1/node_modules/html-parse-stringify/dist/html-parse-stringify.module.js
...
var c = { parse: function(e2, t2) {
  ...
  return e2.replace(r, function(r2, s2) {
    ...
    var u2, f = "/" !== r2.charAt(1), h = r2.startsWith("<!--"), p = s2 + r2.length, d2 = e2.charAt(p);
    if (h) {
      var v = n(r2);
      return l < 0 ? (c2.push(v), c2) : ((u2 = o[l]).children.push(v), c2);
    }
    if (f && (l++, "tag" === (a2 = n(r2)).type && t2.components[a2.name] && (a2.type = "component", m = true), a2.voidElement || m || !d2 || "<" === d2 || a2.children.push({ type: "text", content: e2.slice(p, e2.indexOf("<", p)) }), 0 === l && c2.push(a2), (u2 = o[l - 1]) && u2.children.push(a2), o[l] = a2), (!f || a2.voidElement) && (l > -1 && (a2.voidElement || a2.name === r2.slice(2, -1)) && (l--, a2 = -1 === l ? c2 : o[l]), !m && "<" !== d2 && d2)) {
      u2 = -1 === l ? c2 : o[l].children;
      var x2 = e2.indexOf("<", p), g = e2.slice(p, -1 === x2 ? void 0 : x2);
      i.test(g) && (g = " "), (x2 > -1 && l + u2.length >= 0 || " " !== g) && u2.push({ type: "text", content: g });
    }
  }), c2;
...
// ../../node_modules/.bun/react-i18next@16.5.4+a15ca22a091ca6fb/node_modules/react-i18next/dist/es/utils.js
...
// ../../node_modules/.bun/react-i18next@16.5.4+a15ca22a091ca6fb/node_modules/react-i18next/dist/es/unescape.js
...
// ../../node_modules/.bun/react-i18next@16.5.4+a15ca22a091ca6fb/node_modules/react-i18next/dist/es/defaults.js
var defaultOptions = {
...
// ../../node_modules/.bun/react-i18next@16.5.4+a15ca22a091ca6fb/node_modules/react-i18next/dist/es/i18nInstance.js
var i18nInstance;
...
var hasValidReactChildren = (children) => Array.isArray(children) && children.every(mn);
...
var getValuesFromChildren = (children) => {
  ...
  const getData = (childs) => {
    ...
    childrenArray.forEach((child) => {
      ...
      else if (isObject(child) && !mn(child)) Object.assign(values, child);
    });
  };
  getData(children);
  return values;
...
var renderNodes = (children, knownComponentsMap, targetString, i18n, i18nOptions, combinedTOpts, shouldUnescape) => {
  ...
  const getData = (childs) => {
    ...
    childrenArray.forEach((child) => {
      if (isString(child)) return;
      if (hasChildren(child)) getData(getChildren(child));
      else if (isObject(child) && !mn(child)) Object.assign(data, child);
    });
  };
  getData(children);
  ...
  const pushTranslatedJSX = (child, inner, mem, i2, isVoid) => {
    if (child.dummy) {
      ...
      mem.push(...O.map([child], (c2) => {
        ...
        if (c2 && c2.props) {
          Object.keys(c2.props).forEach((k2) => {
            if (k2 === "ref" || k2 === "children" || k2 === "i18nIsDynamicList" || k2 === INTERNAL_DYNAMIC_MARKER) return;
            override[k2] = c2.props[k2];
          });
        }
        return _n(c2, override, isVoid ? null : inner);
      }));
    }
  };
...
var fixComponentProps = (component, index, translation) => {
  ...
  function Componentized() {
    return _(k, null, comp);
  }
  return _(Componentized, {
    key: componentKey
  });
};
...
function Trans({
  ...
  return useAsParent ? _(useAsParent, additionalProps, content) : content;
}

// ../../node_modules/.bun/react-i18next@16.5.4+a15ca22a091ca6fb/node_modules/react-i18next/dist/es/context.js
init_compat_module();

// ../../node_modules/.bun/react-i18next@16.5.4+a15ca22a091ca6fb/node_modules/react-i18next/dist/es/initReactI18next.js
...
// ../../node_modules/.bun/react-i18next@16.5.4+a15ca22a091ca6fb/node_modules/react-i18next/dist/es/IcuTrans.js
init_compat_module();

// ../../node_modules/.bun/react-i18next@16.5.4+a15ca22a091ca6fb/node_modules/react-i18next/dist/es/IcuTransWithoutContext.js
init_compat_module();

// ../../node_modules/.bun/react-i18next@16.5.4+a15ca22a091ca6fb/node_modules/react-i18next/dist/es/IcuTransUtils/TranslationParserError.js
...
// ../../node_modules/.bun/react-i18next@16.5.4+a15ca22a091ca6fb/node_modules/react-i18next/dist/es/IcuTransUtils/htmlEntityDecoder.js
var commonEntities = {
  "&nbsp;": " ",
  "&amp;": "&",
  "&lt;": "<",
...
var decodeHtmlEntities = (text) => text.replace(entityPattern, (match) => commonEntities[match]).replace(/&#(\d+);/g, (_2, num) => String.fromCharCode(parseInt(num, 10))).replace(/&#x([0-9a-fA-F]+);/g, (_2, hex) => String.fromCharCode(parseInt(hex, 16)));

// ../../node_modules/.bun/react-i18next@16.5.4+a15ca22a091ca6fb/node_modules/react-i18next/dist/es/IcuTransUtils/tokenizer.js
...
// ../../node_modules/.bun/react-i18next@16.5.4+a15ca22a091ca6fb/node_modules/react-i18next/dist/es/IcuTransUtils/renderTranslation.js
init_compat_module();
var renderDeclarationNode = (declaration, children, childDeclarations) => {
  ...
  if (props.children && Array.isArray(props.children) && childDeclarations) {
    ...
    return xn.createElement(type, propsWithoutChildren, ...children);
  }
  if (children.length === 0) {
    return xn.createElement(type, props);
  }
  if (children.length === 1) {
    return xn.createElement(type, props, children[0]);
  }
  return xn.createElement(type, props, ...children);
};
...
function IcuTransWithoutContext({
  ...
  if (!i18n) {
    ...
    return xn.createElement(xn.Fragment, {}, defaultTranslation);
  }
  const t2 = tFromProps || ((_a = i18n.t) == null ? void 0 : _a.bind(i18n)) || ((k2) => k2);
  let namespaces = ns || t2.ns || ((_b = i18n.options) == null ? void 0 : _b.defaultNS);
  namespaces = isString(namespaces) ? [namespaces] : namespaces || ["translation"];
  ...
  try {
    ...
    return xn.createElement(xn.Fragment, {}, ...rendered);
  } catch (error) {
    warn(i18n, "ICU_TRANS_RENDER_ERROR", `IcuTrans component error for key "${i18nKey}": ${error.message}`, {
      i18nKey,
      error
    });
    return xn.createElement(xn.Fragment, {}, translation);
  }
}
...
// ../../node_modules/.bun/react-i18next@16.5.4+a15ca22a091ca6fb/node_modules/react-i18next/dist/es/useTranslation.js
init_compat_module();
...
// ../../node_modules/.bun/react-i18next@16.5.4+a15ca22a091ca6fb/node_modules/react-i18next/dist/es/withTranslation.js
init_compat_module();
var withTranslation = (ns, options = {}) => function Extend(WrappedComponent) {
  function I18nextWithTranslation({
    ...
    return _(WrappedComponent, passDownProps);
  }
  I18nextWithTranslation.displayName = `withI18nextTranslation(${getDisplayName(WrappedComponent)})`;
  I18nextWithTranslation.WrappedComponent = WrappedComponent;
  const forwardRef = (props, ref) => _(I18nextWithTranslation, Object.assign({}, props, {
    forwardedRef: ref
  }));
  return options.withRef ? D(forwardRef) : I18nextWithTranslation;
};

// ../../node_modules/.bun/react-i18next@16.5.4+a15ca22a091ca6fb/node_modules/react-i18next/dist/es/Translation.js
var Translation = ({
  ns,
  children,
  ...options
...
// ../../node_modules/.bun/react-i18next@16.5.4+a15ca22a091ca6fb/node_modules/react-i18next/dist/es/I18nextProvider.js
init_compat_module();
function I18nextProvider({
  ...
  return _(I18nContext.Provider, {
    value
  }, children);
}

// ../../node_modules/.bun/react-i18next@16.5.4+a15ca22a091ca6fb/node_modules/react-i18next/dist/es/withSSR.js
init_compat_module();

// ../../node_modules/.bun/react-i18next@16.5.4+a15ca22a091ca6fb/node_modules/react-i18next/dist/es/useSSR.js
init_compat_module();
...
// ../../node_modules/.bun/react-i18next@16.5.4+a15ca22a091ca6fb/node_modules/react-i18next/dist/es/index.js
var date = () => "";
var time = () => "";
var number = () => "";
var select = () => "";
