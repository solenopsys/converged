...
import "./chunk-EXCIRHG2.js";
import "./chunk-QRLUWPDD.js";
import {
  styled
} from "./chunk-SQMEYDUR.js";
import "./chunk-2O2EBYUB.js";
import "./chunk-JAUQNMSB.js";
import "./chunk-BQ3GRZSB.js";
import "./chunk-DDS7QGHY.js";
import "./chunk-NWASSBAF.js";
import {
  init_compat_module,
  xn
...
import "./chunk-RK4DRYN3.js";
import "./chunk-77ADGTML.js";
import "./chunk-FALXAOLG.js";
import "./chunk-5IKWDFCZ.js";

// ../../node_modules/.bun/@storybook+addon-docs@10.2.8+29ab0d4c53492907/node_modules/@storybook/addon-docs/dist/_browser-chunks/Color-6BZIO3FS.js
init_compat_module();
init_compat_module();
...
var m = xn.memo(function(o2) {
  ...
  return y(function() {
    return H2;
  }, [H2]), xn.createElement("div", u({}, s2, { onTouchStart: C2, onMouseDown: C2, className: "react-colorful__interactive", ref: m2, onKeyDown: E2, tabIndex: 0, role: "slider" }));
});
var g = function(e2) {
...
var p = function(r2) {
  ...
  return xn.createElement("div", { className: l2, style: { top: 100 * a2 + "%", left: 100 * n2 + "%" } }, xn.createElement("div", { className: "react-colorful__pointer-fill", style: { backgroundColor: t2 } }));
};
...
var S = xn.memo(function(r2) {
  var t2 = r2.hue, n2 = r2.onChange, o2 = g(["react-colorful__hue", r2.className]);
  return xn.createElement("div", { className: o2 }, xn.createElement(m, { onMove: function(e2) {
    n2({ h: 360 * e2.left });
  }, onKey: function(e2) {
    n2({ h: s(t2 + 360 * e2.left, 0, 360) });
  }, "aria-label": "Hue", "aria-valuenow": b(t2), "aria-valuemax": "360", "aria-valuemin": "0" }, xn.createElement(p, { className: "react-colorful__hue-pointer", left: t2 / 360, color: q2({ h: t2, s: 100, v: 100, a: 1 }) })));
});
var T2 = xn.memo(function(r2) {
  var t2 = r2.hsva, n2 = r2.onChange, o2 = { backgroundColor: q2({ h: t2.h, s: 100, v: 100, a: 1 }) };
  return xn.createElement("div", { className: "react-colorful__saturation", style: o2 }, xn.createElement(m, { onMove: function(e2) {
    n2({ s: 100 * e2.left, v: 100 - 100 * e2.top });
  }, onKey: function(e2) {
    n2({ s: s(t2.s + 100 * e2.left, 0, 100), v: s(t2.v - 100 * e2.top, 0, 100) });
  }, "aria-label": "Color", "aria-valuetext": "Saturation " + b(t2.s) + "%, Brightness " + b(t2.v) + "%" }, xn.createElement(p, { className: "react-colorful__saturation-pointer", top: 1 - t2.v / 100, left: t2.s / 100, color: q2(t2) })));
});
...
var U = function(t2) {
  ...
  return xn.createElement("div", u({}, s2, { ref: f2, className: m2 }), xn.createElement(T2, { hsva: d22, onChange: h2 }), xn.createElement(S, { hue: d22.h, onChange: h2, className: "react-colorful__last-control" }));
};
var W = { defaultColor: "000", toHsva: x, fromHsva: function(e2) {
  return w({ h: e2.h, s: e2.s, v: e2.v, a: 1 });
}, equal: X };
var Z = function(r2) {
  return xn.createElement(U, u({}, r2, { colorModel: W }));
};
var ee = function(r2) {
  ...
  return xn.createElement("div", { className: l2 }, xn.createElement("div", { className: "react-colorful__alpha-gradient", style: a2 }), xn.createElement(m, { onMove: function(e2) {
    o2({ a: e2.left });
  }, onKey: function(e2) {
    o2({ a: s(n2.a + e2.left) });
  }, "aria-label": "Alpha", "aria-valuetext": u2 + "%", "aria-valuenow": u2, "aria-valuemin": "0", "aria-valuemax": "100" }, xn.createElement(p, { className: "react-colorful__alpha-pointer", left: n2.a, color: k(n2) })));
};
var re = function(t2) {
  var n2 = t2.className, o2 = t2.colorModel, a2 = t2.color, l2 = a2 === void 0 ? o2.defaultColor : a2, i2 = t2.onChange, s2 = c(t2, ["className", "colorModel", "color", "onChange"]), f2 = A(null);
  Q(f2);
  var v2 = Y(o2, l2, i2), d22 = v2[0], h2 = v2[1], m2 = g(["react-colorful", n2]);
  return xn.createElement("div", u({}, s2, { ref: f2, className: m2 }), xn.createElement(T2, { hsva: d22, onChange: h2 }), xn.createElement(S, { hue: d22.h, onChange: h2 }), xn.createElement(ee, { hsva: d22, onChange: h2, className: "react-colorful__last-control" }));
};
var le = { defaultColor: "hsla(0, 0%, 0%, 1)", toHsva: H, fromHsva: k, equal: P };
var ue = function(r2) {
  return xn.createElement(re, u({}, r2, { colorModel: le }));
};
...
var He = function(r2) {
  return xn.createElement(re, u({}, r2, { colorModel: Ee }));
};
...
var useColorInput = (initialValue, onChange) => {
  let [value, setValue] = d(initialValue || ""), [color, setColor] = d(() => parseValue(value)), [colorSpace, setColorSpace] = d(
...
var usePresets = (presetColors, currentColor, colorSpace) => {
  let [selectedColors, setSelectedColors] = d((currentColor == null ? void 0 : currentColor.valid) ? [currentColor] : []);
  y(() => {
    currentColor === void 0 && setSelectedColors([]);
  }, [currentColor]);
  let presets = T(() => (presetColors || []).map((preset) => typeof preset == "string" ? parseValue(preset) : preset.title ? { ...parseValue(preset.color), keyword: preset.title } : parseValue(preset.color)).concat(selectedColors).filter(Boolean).slice(-27), [presetColors, selectedColors]), addPreset = q(
    (color) => {
...
var ColorControl = ({
  ...
  var _a;
  let debouncedOnChange = q(debounce(onChange, 200), [onChange]), { value, realValue, updateValue, color, colorSpace, cycleColorSpace } = useColorInput(
    initialValue,
    debouncedOnChange
  ...
  return xn.createElement(Wrapper, null, xn.createElement("label", { htmlFor: controlId, className: "sb-sr-only" }, name), xn.createElement(
    Input,
    {
      id: controlId,
      value,
    ...
    PopoverProvider,
    {
      ...
      popover: xn.createElement(TooltipContent, null, xn.createElement(
        Picker,
        {
      ...
      ), presets.length > 0 && xn.createElement(Swatches, null, presets.map((preset, index) => xn.createElement(
        SwatchColor,
        {
    ...
    xn.createElement(MarkupIcon, null)
  ) : null);
};
...
//# sourceMappingURL=Color-6BZIO3FS-5L52MXCX.js.map
