...
import {
  require_global
} from "./chunk-77ADGTML.js";
import {
  __toESM
} from "./chunk-5IKWDFCZ.js";

// ../../node_modules/.bun/storybook@10.2.8+57c300bd6617d60e/node_modules/storybook/dist/_browser-chunks/chunk-YKABRMAI.js
init_compat_module();
init_compat_module();
init_compat_module();
init_compat_module();
...
var ActionBar = ({ actionItems, ...props }) => xn.createElement(Container, { ...props }, actionItems.map(({ title, className, onClick, disabled }, index) => xn.createElement(ActionButton, { key: index, className, onClick, disabled: !!disabled }, title)));
...
var Slot = D((props, forwardedRef) => {
  let { children, ...slotProps } = props, childrenArray = O.toArray(children), slottable = childrenArray.find(isSlottable);
  if (slottable) {
    let newElement = slottable.props.children, newChildren = childrenArray.map((child) => child === slottable ? O.count(newElement) > 1 ? O.only(null) : mn(newElement) ? newElement.props.children : null : child);
    return u(SlotClone, { ...slotProps, ref: forwardedRef, children: mn(newElement) ? _n(newElement, void 0, newChildren) : null });
  }
...
var Slottable = ({ children }) => u(k, { children });
function isSlottable(child) {
  return mn(child) && child.type === Slottable;
}
...
var Primitive = NODES.reduce((primitive, node) => {
  let Node = D((props, forwardedRef) => {
    let { asChild, ...primitiveProps } = props, Comp = asChild ? Slot : node;
    return typeof window < "u" && (window[Symbol.for("radix-ui")] = true), u(Comp, { ...primitiveProps, ref: forwardedRef });
  });
...
function useStateMachine(initialState, machine) {
  return h((state, event) => machine[state][event] ?? state, initialState);
}
var Presence = (props) => {
  let { present, children } = props, presence = usePresence(present), child = typeof children == "function" ? children({ present: presence.isPresent }) : O.only(children), ref = useComposedRefs(presence.ref, getElementRef2(child));
  return typeof children == "function" || presence.isPresent ? _n(child, { ref }) : null;
};
Presence.displayName = "Presence";
function usePresence(present) {
  let [node, setNode] = d(), stylesRef = A({}), prevPresentRef = A(present), prevAnimationNameRef = A("none"), initialState = present ? "mounted" : "unmounted", [state, send] = useStateMachine(initialState, {
    mounted: {
      UNMOUNT: "unmounted",
  ...
  return y(() => {
    ...
    if (node) {
      let handleAnimationEnd = (event) => {
        ...
        event.target === node && isCurrentAnimation && En(() => send("ANIMATION_END"));
...
function createContextScope(scopeName, createContextScopeDeps = []) {
  ...
  function createContext3(rootComponentName, defaultContext) {
    let BaseContext = Q(defaultContext), index = defaultContexts.length;
    defaultContexts = [...defaultContexts, defaultContext];
    function Provider(props) {
      let { scope, children, ...context } = props, Context = (scope == null ? void 0 : scope[scopeName][index]) || BaseContext, value = T(() => context, Object.values(context));
      return u(Context.Provider, { value, children });
    }
    function useContext22(consumerName, scope) {
      let Context = (scope == null ? void 0 : scope[scopeName][index]) || BaseContext, context = x(Context);
  ...
  let createScope = () => {
    let scopeContexts = defaultContexts.map((defaultContext) => Q(defaultContext));
...
function useDirection(localDir) {
  let globalDir = x(DirectionContext);
...
var ScrollArea = D(
  (props, forwardedRef) => {
    let {
      ...
      scrollHideDelay = 600,
      ...scrollAreaProps
    } = props, [scrollArea, setScrollArea] = d(null), [viewport, setViewport] = d(null), [content, setContent] = d(null), [scrollbarX, setScrollbarX] = d(null), [scrollbarY, setScrollbarY] = d(null), [cornerWidth, setCornerWidth] = d(0), [cornerHeight, setCornerHeight] = d(0), [scrollbarXEnabled, setScrollbarXEnabled] = d(false), [scrollbarYEnabled, setScrollbarYEnabled] = d(false), composedRefs = useComposedRefs(forwardedRef, (node) => setScrollArea(node)), direction = useDirection(dir);
    return u(
      ScrollAreaProvider,
      {
...
var ScrollAreaViewport = D(
  (props, forwardedRef) => {
    let { __scopeScrollArea, children, asChild, nonce, ...viewportProps } = props, context = useScrollAreaContext(VIEWPORT_NAME, __scopeScrollArea), ref = A(null), composedRefs = useComposedRefs(forwardedRef, ref, context.onViewportChange);
    return u(k, { children: [
      u(
        "style",
        {
...
`
      ...
      u(
        Primitive.div,
        {
          ...
          children: getSubtree({ asChild, children }, (children2) => u(
            "div",
            {
...
var ScrollAreaScrollbar = D(
  (props, forwardedRef) => {
    ...
    return y(() => (isHorizontal ? onScrollbarXEnabledChange(true) : onScrollbarYEnabledChange(true), () => {
      isHorizontal ? onScrollbarXEnabledChange(false) : onScrollbarYEnabledChange(false);
    }), [isHorizontal, onScrollbarXEnabledChange, onScrollbarYEnabledChange]), context.type === "hover" ? u(ScrollAreaScrollbarHover, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "scroll" ? u(ScrollAreaScrollbarScroll, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "auto" ? u(ScrollAreaScrollbarAuto, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "always" ? u(ScrollAreaScrollbarVisible, { ...scrollbarProps, ref: forwardedRef }) : null;
  }
);
ScrollAreaScrollbar.displayName = SCROLLBAR_NAME;
var ScrollAreaScrollbarHover = D((props, forwardedRef) => {
  let { forceMount, ...scrollbarProps } = props, context = useScrollAreaContext(SCROLLBAR_NAME, props.__scopeScrollArea), [visible, setVisible] = d(false);
  return y(() => {
  ...
  }, [context.scrollArea, context.scrollHideDelay]), u(Presence, { present: forceMount || visible, children: u(
...
var ScrollAreaScrollbarScroll = D((props, forwardedRef) => {
  ...
  }, [state, context.scrollHideDelay, send]), y(() => {
  ...
  }, [context.viewport, isHorizontal, send, debounceScrollEnd]), u(Presence, { present: forceMount || state !== "hidden", children: u(
...
var ScrollAreaScrollbarAuto = D((props, forwardedRef) => {
  let context = useScrollAreaContext(SCROLLBAR_NAME, props.__scopeScrollArea), { forceMount, ...scrollbarProps } = props, [visible, setVisible] = d(false), isHorizontal = props.orientation === "horizontal", handleResize = useDebounceCallback(() => {
    if (context.viewport) {
  ...
  return useResizeObserver(context.viewport, handleResize), useResizeObserver(context.content, handleResize), u(Presence, { present: forceMount || visible, children: u(
    ScrollAreaScrollbarVisible,
    {
      "data-state": visible ? "visible" : "hidden",
      ...scrollbarProps,
...
var ScrollAreaScrollbarVisible = D((props, forwardedRef) => {
  let { orientation = "vertical", ...scrollbarProps } = props, context = useScrollAreaContext(SCROLLBAR_NAME, props.__scopeScrollArea), thumbRef = A(null), pointerOffsetRef = A(0), [sizes, setSizes] = d({
    content: 0,
    viewport: 0,
  ...
  return orientation === "horizontal" ? u(
...
var ScrollAreaScrollbarX = D((props, forwardedRef) => {
  let { sizes, onSizesChange, ...scrollbarProps } = props, context = useScrollAreaContext(SCROLLBAR_NAME, props.__scopeScrollArea), [computedStyle, setComputedStyle] = d(), ref = A(null), composeRefs2 = useComposedRefs(forwardedRef, ref, context.onScrollbarXChange);
  return y(() => {
...
var ScrollAreaScrollbarY = D((props, forwardedRef) => {
  let { sizes, onSizesChange, ...scrollbarProps } = props, context = useScrollAreaContext(SCROLLBAR_NAME, props.__scopeScrollArea), [computedStyle, setComputedStyle] = d(), ref = A(null), composeRefs2 = useComposedRefs(forwardedRef, ref, context.onScrollbarYChange);
  return y(() => {
    ref.current && setComputedStyle(getComputedStyle(ref.current));
  }, [ref]), u(
    ScrollAreaScrollbarImpl,
...
var ScrollAreaScrollbarImpl = D((props, forwardedRef) => {
  let {
    __scopeScrollArea,
    sizes,
    hasThumb,
    ...
    onResize,
    ...scrollbarProps
  } = props, context = useScrollAreaContext(SCROLLBAR_NAME, __scopeScrollArea), [scrollbar, setScrollbar] = d(null), composeRefs2 = useComposedRefs(forwardedRef, (node) => setScrollbar(node)), rectRef = A(null), prevWebkitUserSelectRef = A(""), viewport = context.viewport, maxScrollPos = sizes.content - sizes.viewport, handleWheelScroll = useCallbackRef(onWheelScroll), handleThumbPositionChange = useCallbackRef(onThumbPositionChange), handleResize = useDebounceCallback(onResize, 10);
  ...
  }, [viewport, scrollbar, maxScrollPos, handleWheelScroll]), y(handleThumbPositionChange, [sizes, handleThumbPositionChange]), useResizeObserver(scrollbar, handleResize), useResizeObserver(context.content, handleResize), u(
    ScrollbarProvider,
    {
      scope: __scopeScrollArea,
      scrollbar,
...
var ScrollAreaThumb = D(
  (props, forwardedRef) => {
    let { forceMount, ...thumbProps } = props, scrollbarContext = useScrollbarContext(THUMB_NAME, props.__scopeScrollArea);
    return u(Presence, { present: forceMount || scrollbarContext.hasThumb, children: u(ScrollAreaThumbImpl, { ref: forwardedRef, ...thumbProps }) });
  }
);
var ScrollAreaThumbImpl = D(
  (props, forwardedRef) => {
    ...
    ), removeUnlinkedScrollListenerRef = A(), debounceScrollEnd = useDebounceCallback(() => {
    ...
    }, [scrollAreaContext.viewport, debounceScrollEnd, onThumbPositionChange]), u(
      Primitive.div,
      {
...
var ScrollAreaCorner = D(
  (props, forwardedRef) => {
    ...
    return context.type !== "scroll" && hasBothScrollbarsVisible ? u(ScrollAreaCornerImpl, { ...props, ref: forwardedRef }) : null;
  }
);
ScrollAreaCorner.displayName = CORNER_NAME;
var ScrollAreaCornerImpl = D((props, forwardedRef) => {
  let { __scopeScrollArea, ...cornerProps } = props, context = useScrollAreaContext(CORNER_NAME, __scopeScrollArea), [width, setWidth] = d(0), [height, setHeight] = d(0), hasSize = !!(width && height);
...
function useDebounceCallback(callback, delay) {
  let handleCallback = useCallbackRef(callback), debounceTimerRef = A(0);
  return y(() => () => window.clearTimeout(debounceTimerRef.current), []), q(() => {
...
function getSubtree(options, content) {
  ...
  let firstChild = O.only(children);
  return _n(firstChild, {
...
var ScrollArea2 = D(
  ({
    ...
    scrollPadding = 0,
    className
  }, ref) => xn.createElement(ScrollAreaRoot, { scrollbarsize: scrollbarSize, offset, className }, xn.createElement(ScrollAreaViewport2, { ref, style: { scrollPadding } }, children), horizontal && xn.createElement(
    ...
    xn.createElement(ScrollAreaThumb2, null)
  ), vertical && xn.createElement(
    ScrollAreaScrollbar2,
    {
    ...
    xn.createElement(ScrollAreaThumb2, null)
  ), horizontal && vertical && xn.createElement(Corner, null))
);
...
//# sourceMappingURL=chunk-EXCIRHG2.js.map
