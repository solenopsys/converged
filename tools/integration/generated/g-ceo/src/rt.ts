...
const metadata: ServiceMetadata = {
  ...
  "serviceName": "ceo",
  "filePath": "services/content/ceo.ts",
  "methods": [
    {
      "name": "saveJson",
      "parameters": [
...
export interface CeoServiceRtClient {
...
export function createCeoServiceRtClient(): CeoServiceRtClient {
  return createRtClient<CeoServiceRtClient>(metadata);
}
