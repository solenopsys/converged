...
export interface RuntimeAgentServiceRtClient {
...
export function createRuntimeAgentServiceRtClient(): RuntimeAgentServiceRtClient {
  return createRtClient<RuntimeAgentServiceRtClient>(metadata);
}
