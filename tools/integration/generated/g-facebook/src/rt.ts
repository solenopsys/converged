...
export interface FacebookServiceRtClient {
  publishPost(input: FacebookPostInput, credentials: FacebookCredentials): FacebookPostResult;
}

export function createFacebookServiceRtClient(): FacebookServiceRtClient {
  return createRtClient<FacebookServiceRtClient>(metadata);
}
