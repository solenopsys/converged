...
export interface AudioGateServiceRtClient {
...
export function createAudioGateServiceRtClient(): AudioGateServiceRtClient {
  return createRtClient<AudioGateServiceRtClient>(metadata);
}
