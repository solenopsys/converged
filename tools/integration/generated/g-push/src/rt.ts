...
export interface PushServiceRtClient {
  sendPush(input: PushMessageInput, credentials: PushCredentials): PushSendResult;
}

export function createPushServiceRtClient(): PushServiceRtClient {
  return createRtClient<PushServiceRtClient>(metadata);
}
