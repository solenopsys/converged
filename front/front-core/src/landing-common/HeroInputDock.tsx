	...
	return (
		<>
			...
			<div ref={slotRef} className="hsl-hero-input-slot">
				<div
					className={
						docked ? "hsl-hero-input hsl-hero-input--docked" : "hsl-hero-input"
					}
				>
							...
							<div className="hsl-chips">
								{chips.map((chip) => (
									<button
										...
										className={
											chip.variant === "call"
												? "hsl-chip hsl-chip--call"
												: "hsl-chip"
										}
										type="button"
										data-hero-icon={chip.iconName}
										data-hero-prompt={chip.eventName ? undefined : chip.prompt}
										data-landing-event={chip.eventName}
										data-landing-context-name={chip.contextName || contextName}
										data-landing-message={
											chip.eventName ? undefined : chip.prompt
										}
