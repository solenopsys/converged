...
export const $panelConfig = createStore<PanelConfig>({
  ...
  chat: {
    title: "CNC request assistant",
    description: "Describe the part, files, material and deadline. The assistant will create a structured request.",
    inputLabel: "Describe your CNC request...",
    actions: ["add", "mic", "spark"],
    quickCommands: [
      { label: "I need CNC machining. Help me create a request.", icon: "message" },
      { label: "What files and parameters should I prepare?", icon: "bolt" },
      { label: "I have STEP files. Start a machining request.", icon: "spark" },
      { label: "Ask me the missing questions for a quote.", icon: "message" },
    ],
  },
});
