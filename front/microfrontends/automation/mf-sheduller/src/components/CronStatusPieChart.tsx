...
const isErrorLike = (value: string) =>
	/error|failed|failure|fail|ошиб/i.test(value);
			...
			[
				{
					...
					color: isErrorLike("active") ? ERROR_COLOR : COLORS[0],
				},
				{
					key: "paused",
					label: "Paused",
					value: Number(paused ?? 0),
					color: isErrorLike("paused") ? ERROR_COLOR : COLORS[1],
				},
