...
import { HeaderPanel, useMicrofrontendTranslation } from "front-core";
    ...
    <div className="flex h-full min-h-0 flex-col">
      ...
      <div className="p-4 border-b">
        <div className="relative">
          ...
          <input
            type="text"
            placeholder={t("commandsList.searchPlaceholder")}
            value={filter}
      ...
      <div className="flex-1 overflow-auto p-4">
        <div className="text-sm text-muted-foreground mb-4">
          {t("commandsList.available").replace("{count}", String(filteredCommands.length))}
        </div>
        ...
        {filteredCommands.length === 0 && (
          <div className="text-center text-muted-foreground py-8">
            {t("commandsList.empty")}
          </div>
        )}
      </div>

      <div className="border-t bg-muted/30 p-4">
        <div className="text-sm font-semibold mb-2">{t("commandsList.functionInterface")}</div>
