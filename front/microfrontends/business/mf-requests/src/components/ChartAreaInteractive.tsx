			...
			tooltip: {
				...
				formatter: (params: AxisTooltipPoint[]) => {
					...
					const rows = params
						.map(
							(p) =>
								`<span style="display:inline-block;width:8px;height:8px;border-radius:2px;background:${p.color};margin-right:4px"></span>${p.seriesName}: <b>${p.value}</b>`,
						)
						.join("<br/>");
			...
			series: [
				{
					...
					smooth: true,
					symbol: "none",
					lineStyle: { color: "#6366f1", opacity: 0.85 },
					...
					areaStyle: {
						color: {
							...
							y2: 1,
							colorStops: [
								{ offset: 0.05, color: "rgba(99,102,241,0.8)" },
								{ offset: 0.95, color: "rgba(99,102,241,0.1)" },
							],
						},
					},
				},
				{
					...
					smooth: true,
					symbol: "none",
					lineStyle: { color: "#6366f1", opacity: 0.6 },
					itemStyle: { color: "#6366f1" },
					areaStyle: {
						color: {
							type: "linear",
							...
							y2: 1,
							colorStops: [
								{ offset: 0.05, color: "rgba(99,102,241,0.6)" },
								{ offset: 0.95, color: "rgba(99,102,241,0.05)" },
							],
						},
					},
				},
				{
					...
					type: "line",
					yAxisIndex: 1,
					data: filteredData.map((d) => d.conversion),
					smooth: true,
					symbol: "none",
					...
					areaStyle: {
						color: {
							...
							y2: 1,
							colorStops: [
								{ offset: 0.05, color: "rgba(245,158,11,0.5)" },
								{ offset: 0.95, color: "rgba(245,158,11,0.05)" },
							],
						},
					},
				},
