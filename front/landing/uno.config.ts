  ...
  theme: {
    ...
    colors: {
      ...
      sidebar: {
        ...
        primary: "var(--ui-sidebar-primary)",
        "primary-foreground": "var(--ui-sidebar-primary-foreground)",
        accent: "var(--ui-sidebar-accent)",
        "accent-foreground": "var(--ui-sidebar-accent-foreground)",
