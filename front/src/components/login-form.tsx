...
export function LoginForm({
  ...
  const { t } = useTranslation("login") // Используем хук для получения функции перевода
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                >
                  ...
                  <span className="sr-only">{t('button.loginWithApple')}</span>
                </Button>
                <Button 
                  variant="outline" 
                  type="button" 
                ...
                >
                  ...
                  <span className="sr-only">{t('button.loginWithGoogle')}</span>
                </Button>
                <Button 
                  variant="outline" 
                  type="button" 
                  className="w-full"
                  onClick={() => handleSocialLogin("facebook")} // Meta/Facebook provider
                >
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path
                  ...
                  <span className="sr-only">{t('button.loginWithMeta')}</span>
                </Button>
              </div>
      ...
      <div className="text-muted-foreground *:[a]:hover:text-primary text-center text-xs text-balance *:[a]:underline *:[a]:underline-offset-4">
        {t('legal.agreement', {
          termsLink: <a href="#">{t('legal.termsOfService')}</a>,
          privacyLink: <a href="#">{t('legal.privacyPolicy')}</a>
        })}
      </div>
    </div>
  )
