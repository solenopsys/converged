...
export class FileMetadataRepository extends BaseRepositorySQL<FileMetadataKey, FileMetadataEntity> {
}
...
export class FileChunkRepository extends BaseRepositorySQL<FileChunkKey, FileChunkEntity> {
}
