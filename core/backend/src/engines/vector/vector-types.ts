...
export interface RepositorySchema<K extends KeyVector, V> {
...
export interface RepositoryVector<K extends KeyVector, V> {
  ...
  search(vector: number[], options?: SearchOptions): Promise<SearchResult<V>[]>;
}
