    ...
    fn transferLlmToHuman(self: *SipServer, ep: *SipEndpoint) void {
        ...
        const human = human_bridge.HumanEndpoint.create(self.allocator, ep.call_id, .{
            ...
            .transcription = .{
                ...
                .transcription_prompt = self.cfg.bridge_base.transcription_prompt,
                .transcription_keywords = self.cfg.bridge_base.transcription_keywords,
...
fn handleTransferSetup(
    ...
    const ep = human_bridge.HumanEndpoint.create(alloc, ctx.call_id, .{
        ...
        .transcription = .{
            ...
            .transcription_prompt = server.cfg.bridge_base.transcription_prompt,
            .transcription_keywords = server.cfg.bridge_base.transcription_keywords,
