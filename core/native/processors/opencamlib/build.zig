...
pub fn build(b: *std.Build) void {
    ...
    wrapper.setName("build OpenCAMLib wrapper");
    const wrapper_step = b.step("wrapper", "Build libopencamlib.so (CMake, slow)");
    ...
    const test_step = b.step("test", "Run opencamlib processor tests");
