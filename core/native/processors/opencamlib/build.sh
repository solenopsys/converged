#!/usr/bin/env bash
# Builds the opencamlib processor and the native wrapper it dlopens into one
...
WRAPPER_DIR="../../wrappers/slicers/opencamlib"
...
install -Dm644 "$WRAPPER_DIR/zig-out/$TARGET/lib/libopencamlib.so" "$ARTIFACT_DIR/lib/libopencamlib.so"
