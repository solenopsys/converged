...
const DEFAULT_MESSAGES = {
	...
	tab: {
		...
		sections: "Sections",
		openSection: "All sections",
		openItem: "Views and commands",
		catalogHint: "Opens in place of the unpinned tab. Pin to keep it.",
		search: "Search",
	...
	statistics: {
		...
		addSection: "Add to home",
		removeSection: "Remove {title} from home",
...
const RU_MESSAGES = {
	...
	tab: {
		...
		pinNamed: "Закрепить {title}",
		unpinNamed: "Открепить {title}",
		sections: "Разделы",
		openSection: "Все разделы",
		openItem: "Представления и команды",
		catalogHint: "Откроется вместо незакреплённой вкладки. Закрепите, чтобы оставить.",
		search: "Поиск",
		nothingFound: "Ничего не найдено",
		overview: "Обзор",
		groupViews: "Представления",
		groupCommands: "Команды",
	},
	nav: {
		empty: "Разделы недоступны.",
		current: "В этом разделе",
	},
	statistics: {
		empty: "Статистика пока не опубликована.",
		loadingSection: "Загрузка графиков...",
		allHidden: "Все графики этого раздела скрыты.",
		widgetUnavailable: "График не зарегистрировал компонент.",
		hideWidget: "Скрыть {title}",
		loadingSummary: "Загрузка сводки...",
		restoreHidden: "Вернуть скрытые: {count}",
		addSection: "Добавить на главную",
		removeSection: "Убрать {title} с главной",
