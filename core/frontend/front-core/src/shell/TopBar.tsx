...
/**
 * Верхняя панель приложения: слева бренд, по центру либо вкладки рабочих
 * поверхностей, либо навигация лендинга, справа — настройки. Компонент ничего
 * не знает про effector и про то, откуда взялись вкладки: он рисует переданное
 * и сообщает о нажатиях. Вся логика живёт в обёртке (WorkspaceTopBar).
 */
