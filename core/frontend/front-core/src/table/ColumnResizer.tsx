...
export function ColumnResizer({
  ...
  return (
    ...
    >
      <div class="pointer-events-none absolute right-0 top-1/2 -translate-y-1/2 opacity-0 transition-opacity group-hover/resizer:opacity-100">
        <GripVertical size={14} class="text-primary" />
      </div>
    </div>
  );
}
