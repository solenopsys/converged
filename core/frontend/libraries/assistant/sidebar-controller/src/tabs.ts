...
import { $activeTab, $sidebarTabs, tabActivated } from "./store";
...
let iconRenderer: (iconName: string, container: HTMLElement) => void = (
	iconName,
	container,
) => {
...
export const setIconRenderer = (
	renderer: (iconName: string, container: HTMLElement) => void,
) => {
