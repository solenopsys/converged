...
fn printUsage() void {
    std.debug.print(
        "usage:\n" ++
            "  centimanus [serve]\n" ++
            "  centimanus probe-libs\n" ++
            "  centimanus native-smoke\n" ++
            "  centimanus policy-check <caller> <dialed> [context-id] [transfer-uri]\n" ++
            "  centimanus context-set <key> <value|@file>\n" ++
            "  centimanus context-get <key>\n" ++
            "  centimanus signal-openai <offer|@file> [--phone=..] [--context-name=..] [--model=..] [--voice=..] [--instructions=..]\n" ++
            "  centimanus signal-gemini [offer|@file] [--phone=..] [--context-name=..] [--model=..] [--voice=..] [--instructions=..]\n",
        .{},
    );
}
