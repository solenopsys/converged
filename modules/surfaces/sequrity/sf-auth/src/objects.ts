	...
	operations: [
		{
			...
			target: "auth.session",
			label: "Login",
			labelKey: "operations.sessionLogin.label",
			description: "Sign in to your account.",
			descriptionKey: "operations.sessionLogin.description",
			access: "public",
			discover: () => authController.snapshot().session !== "account",
		...
		},
		{
			...
			target: "auth.session",
			label: "Logout",
			labelKey: "operations.sessionLogout.label",
			description: "Sign out of this session.",
			descriptionKey: "operations.sessionLogout.description",
