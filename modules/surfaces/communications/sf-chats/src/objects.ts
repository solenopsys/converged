	...
	operations: [
		{
			...
			target: "chats.chat",
			label: "New room",
			labelKey: "operations.chatCreate.label",
			descriptionKey: "operations.chatCreate.description",
		...
		},
		{
			...
			target: "chats.chat",
			label: "Room members",
			labelKey: "operations.chatMembers.label",
			descriptionKey: "operations.chatMembers.description",
		...
		},
		{
			...
			target: "chats.member",
			label: "Add member",
			labelKey: "operations.memberAdd.label",
			description: "Add a person to a chat room.",
			descriptionKey: "operations.memberAdd.description",
			inputs: [{ name: "room", accepts: objectOf("chats.chat") }],
			parameters: {
				type: "object",
				properties: {
		...
		},
		{
			...
			target: "chats.member",
			label: "Remove member",
			labelKey: "operations.memberRemove.label",
			description: "Remove a person from a chat room.",
			descriptionKey: "operations.memberRemove.description",
			inputs: [{ name: "room", accepts: objectOf("chats.chat") }],
			parameters: {
				type: "object",
				properties: {
