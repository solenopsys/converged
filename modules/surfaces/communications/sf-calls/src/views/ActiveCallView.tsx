...
import { type CallStatus, useWebRTCCall } from "../hooks/useWebRTCCall";
...
export const ActiveCallView: React.FC<ActiveCallViewProps> = ({ onBack }) => {
	...
	// sf-contexts (rp-contexts) — this view only picks which one to dial.
	...
	const { status, error, volume, sessionId, startCall, hangup } = useWebRTCCall(
		phone,
		contextKey,
		scope.trim(),
	);
					...
					<div className="space-y-4">
						<Card>
							...
							<CardContent className="space-y-2 text-xs text-muted-foreground">
								<p>
									1. Enter phone number and press <strong>Start Call</strong>.
								</p>
