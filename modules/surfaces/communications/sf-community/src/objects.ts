	...
	operations: [
		{
			...
			labelKey: "operations.sectionCreate.label",
			descriptionKey: "operations.sectionCreate.description",
		...
		},
		{
			...
			labelKey: "operations.sectionDelete.label",
			descriptionKey: "operations.sectionDelete.description",
		...
		},
		{
			...
			label: "New topic",
			labelKey: "operations.topicCreate.label",
			descriptionKey: "operations.topicCreate.description",
		...
		},
		{
			...
			labelKey: "operations.topicSetFlags.label",
			descriptionKey: "operations.topicSetFlags.description",
