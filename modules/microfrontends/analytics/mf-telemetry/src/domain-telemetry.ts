...
export const telemetryViewMounted = domain.createEvent<TelemetryMode>(
	"TELEMETRY_VIEW_MOUNTED",
);
export const refreshTelemetryClicked = domain.createEvent(
	"REFRESH_TELEMETRY_CLICKED",
);
export const telemetryModeChanged = domain.createEvent<TelemetryMode>(
...
export const $telemetryHotStore = createInfiniteTableStore(
	domain,
	listTelemetryHotFx,
);
export const $telemetryColdStore = createInfiniteTableStore(
	domain,
	listTelemetryColdFx,
);
