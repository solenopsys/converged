...
import { Plus, RefreshCw, Trash2 } from "front-core";
import {
  $filters,
  $staticStore,
    ...
    <HeaderPanelLayout config={headerConfig}>
      <div style={{ display: "flex", gap: 8, marginBottom: 12 }}>
        ...
        <select
          ...
          onChange={(event) =>
            applyFilters({ ...filters, status: event.currentTarget.value, search })
          }
        >
        ...
        <select
          ...
          onChange={(event) =>
            applyFilters({ ...filters, contentType: event.currentTarget.value, search })
          }
        >
