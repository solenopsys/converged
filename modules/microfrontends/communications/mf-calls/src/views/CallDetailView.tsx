			...
			<div className="flex-1 min-h-0 flex flex-col">
				<div className="flex flex-col gap-4 p-4 border-b border-border shrink-0">
					...
					{loading ? (
						...
						<StereoCallPlayer
							userSrc={userAudioUrl}
							aiSrc={assistantAudioUrl}
						/>
					)}
...
const MetaStat: React.FC<{ label: string; value: string }> = ({
	label,
	value,
}) => (
