...
import { createDumpsServiceClient, type DumpsServiceClient } from "g-dumps/browser";
...
export default () => {
  const client: DumpsServiceClient = createDumpsServiceClient(createCliNrpcClientConfig());
