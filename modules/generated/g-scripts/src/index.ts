...
export function createScriptsServiceClient(
  ...
  return createCrullerTransportClient<ScriptsServiceClient>(metadata, config);
}

export function createScriptsServiceCrullerTransportClient(
  config: CrullerTransportClientConfig,
): ScriptsServiceClient {
  return createScriptsServiceClient(config);
}
