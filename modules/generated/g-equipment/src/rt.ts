...
const metadata: ServiceMetadata = {
  ...
  "filePath": "business/equipment.ts",
  "methods": [
    {
...
export interface EquipmentServiceRtClient {
  registerEquipment(input: EquipmentInput): EquipmentId;
  getEquipment(id: EquipmentId): Equipment | any;
  listEquipment(params: EquipmentListParams): PaginatedResult<Equipment>;
  patchEquipment(id: EquipmentId, patch: EquipmentPatch): void;
  deleteEquipment(id: EquipmentId): boolean;
  updateState(id: EquipmentId, state: EquipmentStateInput): void;
  addLog(input: EquipmentLogInput): EquipmentLogId;
  listLogs(params: EquipmentLogListParams): PaginatedResult<EquipmentLog>;
  createScheduleSlot(input: ScheduleSlotInput): ScheduleSlotId;
  listSchedule(params: ScheduleListParams): PaginatedResult<ScheduleSlot>;
  patchScheduleSlot(id: ScheduleSlotId, patch: ScheduleSlotPatch): void;
  getEquipmentDashboard(): EquipmentDashboard;
}

export function createEquipmentServiceRtClient(): EquipmentServiceRtClient {
  return createRtClient<EquipmentServiceRtClient>(metadata);
}
