...
export function createEquipmentServiceClient(
  ...
  return createCrullerTransportClient<EquipmentServiceClient>(metadata, config);
}

export function createEquipmentServiceCrullerTransportClient(
  config: CrullerTransportClientConfig,
): EquipmentServiceClient {
  return createEquipmentServiceClient(config);
}
