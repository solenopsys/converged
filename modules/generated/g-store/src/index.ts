...
export function createStoreServiceClient(
  ...
  return createCrullerTransportClient<StoreServiceClient>(metadata, config);
}

export function createStoreServiceCrullerTransportClient(
  config: CrullerTransportClientConfig,
): StoreServiceClient {
  return createStoreServiceClient(config);
}
