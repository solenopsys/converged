...
export const metadata: ServiceMetadata = {
  ...
  "filePath": "providers/shipmentprovider.ts",
  "methods": [
    {
      "name": "quote",
      "parameters": [
...
export function createShipmentProviderServiceClient(
  ...
  return createCrullerTransportClient<ShipmentProviderServiceClient>(metadata, config);
}

export function createShipmentProviderServiceCrullerTransportClient(
  config: CrullerTransportClientConfig,
): ShipmentProviderServiceClient {
  return createShipmentProviderServiceClient(config);
}
