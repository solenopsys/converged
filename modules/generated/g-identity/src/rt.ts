...
export interface IdentityServiceRtClient {
  ...
  listInvites(params?: InviteListParams): InviteList;
  getInvite(id: string): Invite | any;
  getInviteByEmail(email: string): Invite | any;
  markInviteSent(id: string): Invite | any;
  revokeInvite(id: string): Invite | any;
  consumeInvite(email: string): Invite | any;
}
