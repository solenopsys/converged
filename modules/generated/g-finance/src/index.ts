...
export function createFinanceServiceClient(
  ...
  return createCrullerTransportClient<FinanceServiceClient>(metadata, config);
}

export function createFinanceServiceCrullerTransportClient(
  config: CrullerTransportClientConfig,
): FinanceServiceClient {
  return createFinanceServiceClient(config);
}
