...
export function createShedullerServiceClient(
  ...
  return createCrullerTransportClient<ShedullerServiceClient>(metadata, config);
}

export function createShedullerServiceCrullerTransportClient(
  config: CrullerTransportClientConfig,
): ShedullerServiceClient {
  return createShedullerServiceClient(config);
}
