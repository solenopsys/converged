...
export function createCeoServiceClient(
  ...
  return createCrullerTransportClient<CeoServiceClient>(metadata, config);
}

export function createCeoServiceCrullerTransportClient(
  config: CrullerTransportClientConfig,
): CeoServiceClient {
  return createCeoServiceClient(config);
}
