...
export function createKubernetesServiceClient(
  ...
  return createCrullerTransportClient<KubernetesServiceClient>(metadata, config);
}

export function createKubernetesServiceCrullerTransportClient(
  config: CrullerTransportClientConfig,
): KubernetesServiceClient {
  return createKubernetesServiceClient(config);
}
