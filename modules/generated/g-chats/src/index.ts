...
export const metadata: ServiceMetadata = {
  ...
  "serviceName": "chats",
  "filePath": "communications/chats.ts",
  "methods": [
    {
      "name": "createRoom",
      "parameters": [
...
export function createChatsServiceClient(
  ...
  return createCrullerTransportClient<ChatsServiceClient>(metadata, config);
}

export function createChatsServiceCrullerTransportClient(
  config: CrullerTransportClientConfig,
): ChatsServiceClient {
  return createChatsServiceClient(config);
}
