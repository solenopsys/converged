...
export function createClassifierServiceClient(
  ...
  return createCrullerTransportClient<ClassifierServiceClient>(metadata, config);
}

export function createClassifierServiceCrullerTransportClient(
  config: CrullerTransportClientConfig,
): ClassifierServiceClient {
  return createClassifierServiceClient(config);
}
