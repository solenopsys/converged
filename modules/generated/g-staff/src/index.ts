...
export interface StaffService {
  ...
  getStaffByEmail(email: string): Promise<StaffMember | any>;
...
export function createStaffServiceClient(
  ...
  return createCrullerTransportClient<StaffServiceClient>(metadata, config);
}

export function createStaffServiceCrullerTransportClient(
  config: CrullerTransportClientConfig,
): StaffServiceClient {
  return createStaffServiceClient(config);
}
