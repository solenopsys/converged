...
export interface RuntimeOpencamlibServiceRtClient {
  analyze(request: OpencamlibRequest): OpencamlibReply;
}

export function createRuntimeOpencamlibServiceRtClient(): RuntimeOpencamlibServiceRtClient {
  return createRtClient<RuntimeOpencamlibServiceRtClient>(metadata);
}
