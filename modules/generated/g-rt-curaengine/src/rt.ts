...
export interface RuntimeCuraengineServiceRtClient {
  analyze(request: CuraengineRequest): CuraengineReply;
}

export function createRuntimeCuraengineServiceRtClient(): RuntimeCuraengineServiceRtClient {
  return createRtClient<RuntimeCuraengineServiceRtClient>(metadata);
}
