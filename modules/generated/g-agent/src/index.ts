...
export interface AgentService {
  ...
  ensureSession(sessionId: string, model: string): Promise<SessionInfo>;
...
export function createAgentServiceClient(
  ...
  return createCrullerTransportClient<AgentServiceClient>(metadata, config);
}

export function createAgentServiceCrullerTransportClient(
  config: CrullerTransportClientConfig,
): AgentServiceClient {
  return createAgentServiceClient(config);
}
