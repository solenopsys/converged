...
export function createResonusServiceClient(
  ...
  return createCrullerTransportClient<ResonusServiceClient>(metadata, config);
}

export function createResonusServiceCrullerTransportClient(
  config: CrullerTransportClientConfig,
): ResonusServiceClient {
  return createResonusServiceClient(config);
}
