...
const metadata: ServiceMetadata = {
  ...
  "serviceName": "resonus",
  "filePath": "communications/resonus.ts",
  "methods": [
    {
...
export interface ResonusServiceRtClient {
  savePhoneNumber(input: PhoneNumberInput): PhoneNumberId;
  updatePhoneNumber(id: PhoneNumberId, patch: PhoneNumberUpdate): void;
  getPhoneNumber(id: PhoneNumberId): PhoneNumber | any;
  deletePhoneNumber(id: PhoneNumberId): boolean;
  listPhoneNumbers(params: PhoneNumberListParams): PaginatedResult<PhoneNumber>;
  getPrimaryPhoneNumber(): PhoneNumber | any;
  saveLlmGateConfig(input: LlmGateConfigInput): LlmGateConfigId;
  getLlmGateConfig(id: LlmGateConfigId): LlmGateConfig | any;
  listLlmGateConfigs(): LlmGateConfig[];
  deleteLlmGateConfig(id: LlmGateConfigId): boolean;
}

export function createResonusServiceRtClient(): ResonusServiceRtClient {
  return createRtClient<ResonusServiceRtClient>(metadata);
}
