...
export type ThreadVisibility = | "public"
	| "authenticated"
	| "private"
	| "tagged";
...
export interface ThreadsServiceClient {
  ...
  registerThread(threadId: ULID, kind: ThreadKind, access?: ThreadAccessInput): Promise<void>;
...
export function createThreadsServiceClient(
  ...
  return createWebSocketClient<ThreadsServiceClient>(metadata, config);
}

export function createThreadsServiceWebSocketClient(
  config: WebSocketClientConfig,
): ThreadsServiceClient {
