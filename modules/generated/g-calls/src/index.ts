...
export function createCallsServiceClient(
  ...
  return createCrullerTransportClient<CallsServiceClient>(metadata, config);
}

export function createCallsServiceCrullerTransportClient(
  config: CrullerTransportClientConfig,
): CallsServiceClient {
  return createCallsServiceClient(config);
}
