...
export function createBillingServiceClient(
  ...
  return createCrullerTransportClient<BillingServiceClient>(metadata, config);
}

export function createBillingServiceCrullerTransportClient(
  config: CrullerTransportClientConfig,
): BillingServiceClient {
  return createBillingServiceClient(config);
}
