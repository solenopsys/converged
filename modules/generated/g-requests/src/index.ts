...
export function createRequestsServiceClient(
  ...
  return createCrullerTransportClient<RequestsServiceClient>(metadata, config);
}

export function createRequestsServiceCrullerTransportClient(
  config: CrullerTransportClientConfig,
): RequestsServiceClient {
  return createRequestsServiceClient(config);
}
