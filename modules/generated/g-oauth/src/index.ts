...
export function createOAuthServiceClient(
  ...
  return createCrullerTransportClient<OAuthServiceClient>(metadata, config);
}

export function createOAuthServiceCrullerTransportClient(
  config: CrullerTransportClientConfig,
): OAuthServiceClient {
  return createOAuthServiceClient(config);
}
