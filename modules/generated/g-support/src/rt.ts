...
export interface SupportServiceRtClient {
  createTicket(input: CreateTicketInput): Ticket;
  getTicket(id: TicketId): Ticket | any;
  listTickets(params: TicketListParams): PaginatedResult<Ticket>;
  vote(id: TicketId): number;
  unvote(id: TicketId): number;
  setStatus(id: TicketId, status: TicketStatus): Ticket;
}

export function createSupportServiceRtClient(): SupportServiceRtClient {
  return createRtClient<SupportServiceRtClient>(metadata);
}
