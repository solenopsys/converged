...
export function createSalesServiceClient(
  ...
  return createCrullerTransportClient<SalesServiceClient>(metadata, config);
}

export function createSalesServiceCrullerTransportClient(
  config: CrullerTransportClientConfig,
): SalesServiceClient {
  return createSalesServiceClient(config);
}
