...
export function createFunctionsServiceClient(
  ...
  return createCrullerTransportClient<FunctionsServiceClient>(metadata, config);
}

export function createFunctionsServiceCrullerTransportClient(
  config: CrullerTransportClientConfig,
): FunctionsServiceClient {
  return createFunctionsServiceClient(config);
}
