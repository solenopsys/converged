...
export interface StaticServiceRtClient {
  getData(id: string): string | any;
  setData(params: SetDataParams): StaticMeta;
  setMeta(params: SetMetaParams): StaticMeta;
  getMeta(id: string): StaticMeta | any;
  listMeta(params: ListMetaParams): StaticMetaListResult;
  getOneByStatus(status: StaticStatus): StaticMeta | any;
  setStatus(id: string, status: StaticStatus): StaticMeta;
  setStatusPattern(params: SetStatusPatternParams): SetStatusPatternResult;
  deleteMeta(id: string): void;
  deleteEntry(id: string): void;
  flush(): FlushResult;
  describeSelection(objectType: string): SelectionDescriptor;
  inspectCacheEntries(filter?: FilterObject): SelectionStats;
}

export function createStaticServiceRtClient(): StaticServiceRtClient {
  return createRtClient<StaticServiceRtClient>(metadata);
}
